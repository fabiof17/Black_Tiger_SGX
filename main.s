...
.LL43:
	...
	.dbg	line,	"include\routines_LEVELS.c", 288; player_state = STATE_WALK;
	__st.umiq	1, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 289; player_axis = AXIS_RIGHT;
	__st.umiq	0, _player_axis

	.dbg	line,	"include\routines_LEVELS.c", 291; if(player_previous_axis != player_axis)
	...
	.dbg	line,	"include\routines_LEVELS.c", 293; player_previous_axis = player_axis;
	__ld.um		_player_axis
	__st.umq	_player_previous_axis

	.dbg	line,	"include\routines_LEVELS.c", 295; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 296; spr_ctrl(FLIP_MAS, NO_FLIP_X);
	__st.umiq	136, _al
	__ld.uiq	0
	__call		_spr_ctrl.2
...
.LL44	.alias		.LL45
	...
	.dbg	line,	"include\routines_LEVELS.c", 301; else if(player_state == STATE_JUMP || player_state == STATE_JUMP_LEFT || player_state == STATE_CROUCH || player_state == STATE_FALL || player_state == STATE_HANG)
	__bra		.LL45
.LL42:
	__ld.umq	_player_state
	__equ_b.uiq	4
...
.LL50:
	...
	.dbg	line,	"include\routines_LEVELS.c", 303; if(player_axis == AXIS_LEFT)
	...
	.dbg	line,	"include\routines_LEVELS.c", 305; player_axis = AXIS_RIGHT;
	__st.umiq	0, _player_axis

	.dbg	line,	"include\routines_LEVELS.c", 306; player_previous_axis = player_axis;
	__ld.um		_player_axis
	__st.umq	_player_previous_axis

	.dbg	line,	"include\routines_LEVELS.c", 308; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 309; spr_ctrl(FLIP_MAS, NO_FLIP_X);
	__st.umiq	136, _al
	__ld.uiq	0
	__call		_spr_ctrl.2
...
.LL51	.alias		.LL52
	...
	.dbg	line,	"include\routines_LEVELS.c", 314; else if(player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__bra		.LL52
.LL46:
	__ld.umq	_player_state
	__equ_b.uiq	11
...
.LL54:
	...
	.dbg	line,	"include\routines_LEVELS.c", 316; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 317; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL45	.alias		.LL55
	...
	.dbg	line,	"include\routines_LEVELS.c", 322; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 323; //                                     LEFT BUTTON                                      //

	.dbg	line,	"include\routines_LEVELS.c", 324; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 326; else if(joy(JOYPAD_1) & JOY_LEFT)
	__bra		.LL55
.LL41:
	__ld.uiq	0
	 _joy.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 328; if(player_state == STATE_IDLE || player_state == STATE_WALK)
	__not.um	_player_state
	__btrue		.LL58
	__ld.umq	_player_state
	__equ_b.uiq	1
.LL58:
	...
	.dbg	line,	"include\routines_LEVELS.c", 330; player_state = STATE_WALK;
	__st.umiq	1, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 331; player_axis = AXIS_LEFT;
	__st.umiq	1, _player_axis

	.dbg	line,	"include\routines_LEVELS.c", 333; if(player_previous_axis != player_axis)
	__ld.umq	_player_previous_axis
	__neq_b.umq	_player_axis
	__bfalse	.LL59
	...
	.dbg	line,	"include\routines_LEVELS.c", 335; player_previous_axis = player_axis;
	__ld.um		_player_axis
	__st.umq	_player_previous_axis

	.dbg	line,	"include\routines_LEVELS.c", 337; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 338; spr_ctrl(FLIP_MAS, FLIP_X);
	__st.umiq	136, _al
	__ld.uiq	8
	__call		_spr_ctrl.2
...
.LL59	.alias		.LL60
	...
	.dbg	line,	"include\routines_LEVELS.c", 343; else if(player_state == STATE_JUMP || player_state == STATE_JUMP_RIGHT || player_state == STATE_CROUCH || player_state == STATE_FALL || player_state == STATE_HANG)
	__bra		.LL60
.LL57:
	__ld.umq	_player_state
	__equ_b.uiq	4
...
.LL65:
	...
	.dbg	line,	"include\routines_LEVELS.c", 345; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL66

	.dbg	line,	"include\routines_LEVELS.c", 346; {

	.dbg	line,	"include\routines_LEVELS.c", 347; player_axis = AXIS_LEFT;
	__st.umiq	1, _player_axis

	.dbg	line,	"include\routines_LEVELS.c", 348; player_previous_axis = player_axis;
	__ld.um		_player_axis
	__st.umq	_player_previous_axis

	.dbg	line,	"include\routines_LEVELS.c", 350; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 351; spr_ctrl(FLIP_MAS, FLIP_X);
	__st.umiq	136, _al
	__ld.uiq	8
	__call		_spr_ctrl.2
...
.LL66	.alias		.LL67
	...
	.dbg	line,	"include\routines_LEVELS.c", 356; else if(player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__bra		.LL67
.LL61:
	__ld.umq	_player_state
	__equ_b.uiq	11
...
.LL69:
	...
	.dbg	line,	"include\routines_LEVELS.c", 359; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL60	.alias		.LL70
	...
	.dbg	line,	"include\routines_LEVELS.c", 365; //                                      UP BUTTON                                       //

	.dbg	line,	"include\routines_LEVELS.c", 366; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 368; else if(joy(JOYPAD_1) & JOY_UP)
	__bra		.LL70
.LL56:
	__ld.uiq	0
	 _joy.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 370; if(player_state == STATE_HANG || player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__ld.umq	_player_state
	__equ_b.uiq	10
	__btrue		.LL73
	__ld.umq	_player_state
...
.LL74:
	...
	.dbg	line,	"include\routines_LEVELS.c", 372; unsigned char i;

	.dbg	line,	"include\routines_LEVELS.c", 374; check_LADDER( 15 , 8 );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		8
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 376; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL75

	.dbg	line,	"include\routines_LEVELS.c", 377; {

	.dbg	line,	"include\routines_LEVELS.c", 378; for(i=1 ; i<3 ; i++)
...
.LL78:
	...
	.dbg	line,	"include\routines_LEVELS.c", 380; check_LADDER( 15 , 8 + i );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		8
	...
	.dbg	line,	"include\routines_LEVELS.c", 382; if(map_blk_flag == TILE_LADDER)
	...
	.dbg	line,	"include\routines_LEVELS.c", 384; sgx_map_pxl_y -= (2 - i);
	__ld.wi		2
	__sub.um	__joypad_DIR_end - 1  /* i */
	__isub_st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 385; break;
	__bra		.LL79
...
.LL79	.alias		.LL81
	...
	.dbg	line,	"include\routines_LEVELS.c", 390; else
	__bra		.LL81
.LL75:

	.dbg	line,	"include\routines_LEVELS.c", 391; {

	.dbg	line,	"include\routines_LEVELS.c", 392; sgx_map_pxl_y -= 2;
	__sub_st.wmiq	2, _sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 393; }
.LL81:

	.dbg	line,	"include\routines_LEVELS.c", 395; player_state = STATE_CLIMB_UP;
...
.LL72	.alias		.LL82
	...
	.dbg	line,	"include\routines_LEVELS.c", 401; //                                     DOWN BUTTON                                      //

	.dbg	line,	"include\routines_LEVELS.c", 402; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 404; else if(joy(JOYPAD_1) & JOY_DOWN)
	__bra		.LL82
.LL71:
	__ld.uiq	0
	 _joy.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 406; if(player_state == STATE_IDLE || player_state == STATE_WALK)
	__not.um	_player_state
	__btrue		.LL85
	__ld.umq	_player_state
	__equ_b.uiq	1
.LL85:
	...
	.dbg	line,	"include\routines_LEVELS.c", 408; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 409; player_state = STATE_CROUCH;
	__st.umiq	7, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 410; }

	.dbg	line,	"include\routines_LEVELS.c", 413; else if(player_state == STATE_HANG || player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__bra		.LL86
.LL84:
	__ld.umq	_player_state
	__equ_b.uiq	10
...
.LL89:
	...
	.dbg	line,	"include\routines_LEVELS.c", 415; unsigned char i;

	.dbg	line,	"include\routines_LEVELS.c", 417; check_LADDER( 15 , 10 );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		10
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 419; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL90

	.dbg	line,	"include\routines_LEVELS.c", 420; {

	.dbg	line,	"include\routines_LEVELS.c", 421; for(i=1 ; i<3 ; i++)
...
.LL93:
	...
	.dbg	line,	"include\routines_LEVELS.c", 423; check_LADDER( 15 , 22 + i );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		22
	...
	.dbg	line,	"include\routines_LEVELS.c", 425; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL95
	...
	.dbg	line,	"include\routines_LEVELS.c", 427; sgx_map_pxl_y += (2 - i);
	__ld.wi		2
	...
	.dbg	line,	"include\routines_LEVELS.c", 431; else
.LL95:

	.dbg	line,	"include\routines_LEVELS.c", 432; {

	.dbg	line,	"include\routines_LEVELS.c", 433; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_224 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 7168 + 512, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 434; player_state = STATE_FALL;
...
.LL94	.alias		.LL97
	...
	.dbg	line,	"include\routines_LEVELS.c", 439; else
	__bra		.LL97
.LL90:

	.dbg	line,	"include\routines_LEVELS.c", 440; {

	.dbg	line,	"include\routines_LEVELS.c", 441; sgx_map_pxl_y += 2;
	__add_st.wmiq	2, _sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 442; player_state = STATE_CLIMB_DOWN;
...
__joypad_DIR_end:
	...
	.dbg	line,	"include\routines_LEVELS.c", 455; void update_PLAYER()
...
;***********************
	...
	.dbg	line,	"include\routines_LEVELS.c", 457; if(player_state == STATE_IDLE)
	__not.um	_player_state
	__bfalse	.LL99

	.dbg	line,	"include\routines_LEVELS.c", 458; {

	.dbg	line,	"include\routines_LEVELS.c", 459; if(player_counter_anim == 1)
	...
	.dbg	line,	"include\routines_LEVELS.c", 461; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 463; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 464; }

	.dbg	line,	"include\routines_LEVELS.c", 466; recenter_CAMERA();
.LL100:
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 467; }

	.dbg	line,	"include\routines_LEVELS.c", 470; else if(player_state == STATE_WALK)
	__bra		.LL101
.LL99:
	__ld.umq	_player_state
	__equ_b.uiq	1
	...
	.dbg	line,	"include\routines_LEVELS.c", 472; recenter_CAMERA();
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 475; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL103

	.dbg	line,	"include\routines_LEVELS.c", 476; {

	.dbg	line,	"include\routines_LEVELS.c", 477; // CHECK COLLISION WITH FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 478; check_FLOOR_L();
	__call		_check_FLOOR_L

	.dbg	line,	"include\routines_LEVELS.c", 480; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL104

	.dbg	line,	"include\routines_LEVELS.c", 481; {

	.dbg	line,	"include\routines_LEVELS.c", 482; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 484; player_state = STATE_FALL;
	__st.umiq	9, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 485; }

	.dbg	line,	"include\routines_LEVELS.c", 489; // CHECK COLLISION WITH WALLS //

	.dbg	line,	"include\routines_LEVELS.c", 490; check_WALL_BR();
.LL104:
...
.LL105	.alias		.LL106
	...
	.dbg	line,	"include\routines_LEVELS.c", 499; else if(player_axis == AXIS_LEFT)
	__bra		.LL106
.LL103:
	__ld.umq	_player_axis
	__equ_b.uiq	1
	...
	.dbg	line,	"include\routines_LEVELS.c", 501; // CHECK COLLISION WITH FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 502; check_FLOOR_R();
	__call		_check_FLOOR_R

	.dbg	line,	"include\routines_LEVELS.c", 504; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL108

	.dbg	line,	"include\routines_LEVELS.c", 505; {

	.dbg	line,	"include\routines_LEVELS.c", 506; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 508; player_state = STATE_FALL;
	__st.umiq	9, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 509; }

	.dbg	line,	"include\routines_LEVELS.c", 512; // CHECK COLLISION WITH BG //

	.dbg	line,	"include\routines_LEVELS.c", 513; check_WALL_BL();
.LL108:
	__call		_check_WALL_BL

	.dbg	line,	"include\routines_LEVELS.c", 515; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL109

	.dbg	line,	"include\routines_LEVELS.c", 516; {

	.dbg	line,	"include\routines_LEVELS.c", 517; sgx_map_pxl_x -= 2;
...
.LL109:
	...
	.dbg	line,	"include\routines_LEVELS.c", 524; spr_set(player_id);
.LL107:
.LL106:
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 527; // UPDATE PLAYER TILES //

	.dbg	line,	"include\routines_LEVELS.c", 528; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL110

	.dbg	line,	"include\routines_LEVELS.c", 529; {

	.dbg	line,	"include\routines_LEVELS.c", 530; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 534; else if(player_counter_anim == 2)
	__bra		.LL111
.LL110:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	2
	...
	.dbg	line,	"include\routines_LEVELS.c", 536; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_1 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 540; else if(player_counter_anim == 5)
	__bra		.LL113
.LL112:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	5
	...
	.dbg	line,	"include\routines_LEVELS.c", 542; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_2 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 546; else if(player_counter_anim == 8)
	__bra		.LL115
.LL114:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	8
	...
	.dbg	line,	"include\routines_LEVELS.c", 548; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_3 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 552; else if(player_counter_anim == 11)
	__bra		.LL117
.LL116:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	11
	...
	.dbg	line,	"include\routines_LEVELS.c", 554; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 558; else if(player_counter_anim == 14)
	__bra		.LL119
.LL118:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	14
	...
	.dbg	line,	"include\routines_LEVELS.c", 560; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_4 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 564; else if(player_counter_anim == 17)
	__bra		.LL121
.LL120:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	17
	...
	.dbg	line,	"include\routines_LEVELS.c", 566; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_5 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 570; else if(player_counter_anim == 20)
	__bra		.LL123
.LL122:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	20
	...
	.dbg	line,	"include\routines_LEVELS.c", 572; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_6 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 576; else if(player_counter_anim == 22)
	__bra		.LL125
.LL124:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	22
	...
	.dbg	line,	"include\routines_LEVELS.c", 578; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 580; return;
	__bra		.LL98

	.dbg	line,	"include\routines_LEVELS.c", 581; }

	.dbg	line,	"include\routines_LEVELS.c", 584; player_counter_anim += 1;
.LL126:
.LL125:
.LL123:
.LL121:
...
.LL111:
	...
	.dbg	line,	"include\routines_LEVELS.c", 589; else if(player_state == STATE_JUMP)
	__bra		.LL127
.LL102:
	__ld.umq	_player_state
	__equ_b.uiq	4
	...
	.dbg	line,	"include\routines_LEVELS.c", 591; unsigned char i;

	.dbg	line,	"include\routines_LEVELS.c", 592; i = 1;
	__st.umiq	1, __update_PLAYER_end - 1  /* i */

	.dbg	line,	"include\routines_LEVELS.c", 595; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL129

	.dbg	line,	"include\routines_LEVELS.c", 596; {

	.dbg	line,	"include\routines_LEVELS.c", 597; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_112 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 3584, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 599; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 600; }

	.dbg	line,	"include\routines_LEVELS.c", 603; player_pos_y += TABLE_PLAYER_JUMP_V[player_index_jump];
.LL129:
	__ldx.umq	_player_index_jump
	__ld.bax	_TABLE_PLAYER_JUMP_V
	__add_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 605; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 606; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 610; if(player_index_jump < 34)
	...
	.dbg	line,	"include\routines_LEVELS.c", 612; player_index_jump += 1;
	__add_st.umiq	1, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 613; }

	.dbg	line,	"include\routines_LEVELS.c", 616; // CHECK COLLISION WITH FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 617; if(player_axis == AXIS_RIGHT)
.LL130:
	__not.um	_player_axis
	__bfalse	.LL131
	...
	.dbg	line,	"include\routines_LEVELS.c", 619; check_FLOOR_R();
	__call		_check_FLOOR_R

	.dbg	line,	"include\routines_LEVELS.c", 620; }

	.dbg	line,	"include\routines_LEVELS.c", 622; else
	__bra		.LL132
.LL131:

	.dbg	line,	"include\routines_LEVELS.c", 623; {

	.dbg	line,	"include\routines_LEVELS.c", 624; check_FLOOR_L();
	__call		_check_FLOOR_L

	.dbg	line,	"include\routines_LEVELS.c", 625; }
.LL132:

	.dbg	line,	"include\routines_LEVELS.c", 628; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL133
	...
	.dbg	line,	"include\routines_LEVELS.c", 630; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 631; for(i=1; i<11 ; i++ )
	__st.umiq	1, __update_PLAYER_end - 1  /* i */
.LL134:
...
.LL136:
	...
	.dbg	line,	"include\routines_LEVELS.c", 635; check_BG( 11 , i);
	__ld.wi		11
	__pusharg.wr
...
.LL138:
	...
	.dbg	line,	"include\routines_LEVELS.c", 640; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 1  /* i */
	__pusharg.wr
...
.LL139:
	...
	.dbg	line,	"include\routines_LEVELS.c", 644; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL140

	.dbg	line,	"include\routines_LEVELS.c", 645; {

	.dbg	line,	"include\routines_LEVELS.c", 646; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 648; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 1  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 649; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 650; break;
	__bra		.LL137
...
.LL137:
	...
	.dbg	line,	"include\routines_LEVELS.c", 655; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 656; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 657; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 658; return;
	__bra		.LL98

	.dbg	line,	"include\routines_LEVELS.c", 659; }

	.dbg	line,	"include\routines_LEVELS.c", 662; // CHECK COLLISION WITH LADDERS //

	.dbg	line,	"include\routines_LEVELS.c", 663; check_LADDER( 16 , 16 );
.LL133:
	__ld.wi		16
	__pusharg.wr
	__ld.wi		16
	...
	.dbg	line,	"include\routines_LEVELS.c", 665; // IF PLAYER HITS THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 666; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL141
	...
	.dbg	line,	"include\routines_LEVELS.c", 668; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 669; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 671; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 672; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 674; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 675; check_LADDER( 31 , 16 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 677; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL142
	...
	.dbg	line,	"include\routines_LEVELS.c", 679; sgx_map_pxl_x += 8;
	__add_st.wmiq	8, _sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 680; }

	.dbg	line,	"include\routines_LEVELS.c", 682; player_counter_anim = 1;
.LL142:
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 683; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 684; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL141	.alias		.LL143
	...
	.dbg	line,	"include\routines_LEVELS.c", 689; else if(player_state == STATE_JUMP_RIGHT)
	__bra		.LL143
.LL128:
	__ld.umq	_player_state
	__equ_b.uiq	5
	...
	.dbg	line,	"include\routines_LEVELS.c", 691; unsigned char i, camera_y_move;

	.dbg	line,	"include\routines_LEVELS.c", 692; i = 1;
	__st.umiq	1, __update_PLAYER_end - 2  /* i */

	.dbg	line,	"include\routines_LEVELS.c", 695; // UPDATE PLAYER TILES //

	.dbg	line,	"include\routines_LEVELS.c", 696; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL145

	.dbg	line,	"include\routines_LEVELS.c", 697; {

	.dbg	line,	"include\routines_LEVELS.c", 698; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_112 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 3584, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 700; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 701; }

	.dbg	line,	"include\routines_LEVELS.c", 704; // SELECT PLAYER SPRITE //

	.dbg	line,	"include\routines_LEVELS.c", 705; spr_set(player_id);
.LL145:
	__ld.umq	_player_id
	__call		_spr_set.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 709; //                                        H MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 710; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 712; // CHECK COLLISION WITH RIGHT WALL //

	.dbg	line,	"include\routines_LEVELS.c", 713; // IF THE PLAYER HAS NOT YET COLLIDED WITH A WALL //

	.dbg	line,	"include\routines_LEVELS.c", 714; //if(collision_side == FALSE)

	.dbg	line,	"include\routines_LEVELS.c", 715; //{

	.dbg	line,	"include\routines_LEVELS.c", 716; check_WALL_BR();
	__call		_check_WALL_BR

	.dbg	line,	"include\routines_LEVELS.c", 718; if(map_blk_flag != TILE_BG)
	__ld.umq	_map_blk_flag
	__neq_b.uiq	1
	__bfalse	.LL146
	...
	.dbg	line,	"include\routines_LEVELS.c", 720; check_WALL_TR();
	...
	.dbg	line,	"include\routines_LEVELS.c", 724; player_state = STATE_FALL;
	__st.umiq	9, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 725; }

	.dbg	line,	"include\routines_LEVELS.c", 727; else
	__bra		.LL148
.LL147:

	.dbg	line,	"include\routines_LEVELS.c", 728; {

	.dbg	line,	"include\routines_LEVELS.c", 729; sgx_map_pxl_x += 2;
	__add_st.wmiq	2, _sgx_map_pxl_x
...
.LL148:
	...
	.dbg	line,	"include\routines_LEVELS.c", 736; //                                        V MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 737; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 739; // UPDATE PLAYER Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 740; player_pos_y += TABLE_PLAYER_JUMP_V[player_index_jump];
.LL146:
	__ldx.umq	_player_index_jump
	__ld.bax	_TABLE_PLAYER_JUMP_V
	__add_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 743; // IF PLAYER GOES BELOW ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 744; if(player_pos_y >= PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__sge_w.wi	128
	__bfalse	.LL149
	...
	.dbg	line,	"include\routines_LEVELS.c", 746; // THE CAMERA MOVES //

	.dbg	line,	"include\routines_LEVELS.c", 747; // CALCULATE HOW MANY PIXELS THE CAMERA HAS TO MOVE DOWN //

	.dbg	line,	"include\routines_LEVELS.c", 748; camera_y_move = player_pos_y - PLAYER_BASE_Y_POS;
	__ld.wm		_player_pos_y
	__sub.wi	128
	__st.umq	__update_PLAYER_end - 3  /* camera_y_move */

	.dbg	line,	"include\routines_LEVELS.c", 749; sgx_map_pxl_y += camera_y_move;
	__ld.um		__update_PLAYER_end - 3  /* camera_y_move */
	__add_st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 751; // IF THE CAMERA HAS REACHED ITS MAX (LOWEST) POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 752; if(sgx_map_pxl_y > camera_max_y_position)
	__ld.wm		_sgx_map_pxl_y
	...
	.dbg	line,	"include\routines_LEVELS.c", 754; // THE CAMERA CAN NOT MOVE LOWER //

	.dbg	line,	"include\routines_LEVELS.c", 755; sgx_map_pxl_y = camera_max_y_position;
	__ld.wm		_camera_max_y_position
	__st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 756; }

	.dbg	line,	"include\routines_LEVELS.c", 758; // THE PLAYER STAYS AT ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 759; player_pos_y = PLAYER_BASE_Y_POS;
.LL150:
	__st.wmiq	128, _player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 761; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 762; }

	.dbg	line,	"include\routines_LEVELS.c", 765; // UPDATE JUMP INDEX IN THE ARRAY //

	.dbg	line,	"include\routines_LEVELS.c", 766; // ARRAY MAX ENTRY : 34 //

	.dbg	line,	"include\routines_LEVELS.c", 767; if(player_index_jump < 34)
.LL149:
	__ld.umq	_player_index_jump
	__ult_b.uiq	34
	__bfalse	.LL151
	...
	.dbg	line,	"include\routines_LEVELS.c", 769; player_index_jump += 1;
	__add_st.umiq	1, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 770; }

	.dbg	line,	"include\routines_LEVELS.c", 773; // CHECK COLLISION WITH THE FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 774; check_FLOOR_R();
.LL151:
	__call		_check_FLOOR_R

	.dbg	line,	"include\routines_LEVELS.c", 777; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL152
	...
	.dbg	line,	"include\routines_LEVELS.c", 779; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 780; for(i=1; i<11 ; i++)
	__st.umiq	1, __update_PLAYER_end - 2  /* i */
.LL153:
...
.LL155:
	...
	.dbg	line,	"include\routines_LEVELS.c", 782; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL157

	.dbg	line,	"include\routines_LEVELS.c", 783; {

	.dbg	line,	"include\routines_LEVELS.c", 784; check_BG( 11 , i);
	__ld.wi		11
	__pusharg.wr
...
.LL157:
	...
	.dbg	line,	"include\routines_LEVELS.c", 789; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 2  /* i */
	__pusharg.wr
...
.LL158:
	...
	.dbg	line,	"include\routines_LEVELS.c", 793; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL159

	.dbg	line,	"include\routines_LEVELS.c", 794; {

	.dbg	line,	"include\routines_LEVELS.c", 795; if(player_pos_y != PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__neq_w.wi	128
	__bfalse	.LL160
	...
	.dbg	line,	"include\routines_LEVELS.c", 797; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 2  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y
...
.LL160:
	...
	.dbg	line,	"include\routines_LEVELS.c", 802; sgx_map_pxl_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 2  /* i */
	__sub.wi	1
	__isub_st.wmq	_sgx_map_pxl_y
...
.LL161	.alias		.LL156
	...
	.dbg	line,	"include\routines_LEVELS.c", 805; break;
	__bra		.LL156
...
.LL156:
	...
	.dbg	line,	"include\routines_LEVELS.c", 809; // SET PLAYER SPRITE NEW POSITION //
	...
	.dbg	line,	"include\routines_LEVELS.c", 813; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 814; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 815; return;
	__bra		.LL98

	.dbg	line,	"include\routines_LEVELS.c", 816; }

	.dbg	line,	"include\routines_LEVELS.c", 819; // CHECK COLLISION WITH LADDERS //

	.dbg	line,	"include\routines_LEVELS.c", 820; if(player_index_jump > 4)
.LL152:
	__ld.umq	_player_index_jump
	__ugt_b.uiq	4
	__bfalse	.LL162
	...
	.dbg	line,	"include\routines_LEVELS.c", 822; check_LADDER( 16 , 16 );
	__ld.wi		16
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 824; // IF PLAYER HITS THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 825; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL163
	...
	.dbg	line,	"include\routines_LEVELS.c", 827; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 828; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 830; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 831; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 833; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 834; check_LADDER( 31 , 16 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 836; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL164
	...
	.dbg	line,	"include\routines_LEVELS.c", 838; sgx_map_pxl_x += 8;
	__add_st.wmiq	8, _sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 839; }

	.dbg	line,	"include\routines_LEVELS.c", 841; player_counter_anim = 1;
.LL164:
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 842; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 843; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL163:
	...
	.dbg	line,	"include\routines_LEVELS.c", 848; // SET PLAYER SPRITE NEW POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 849; spr_y(player_pos_y);
.LL162:
	__ld.wm		_player_pos_y
	__call		_spr_y.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 853; else if(player_state == STATE_JUMP_LEFT)
	__bra		.LL165
.LL144:
	__ld.umq	_player_state
	__equ_b.uiq	6
	...
	.dbg	line,	"include\routines_LEVELS.c", 855; unsigned char i, camera_y_move;

	.dbg	line,	"include\routines_LEVELS.c", 856; i = 1;
	__st.umiq	1, __update_PLAYER_end - 4  /* i */

	.dbg	line,	"include\routines_LEVELS.c", 859; // UPDATE PLAYER TILES //

	.dbg	line,	"include\routines_LEVELS.c", 860; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL167

	.dbg	line,	"include\routines_LEVELS.c", 861; {

	.dbg	line,	"include\routines_LEVELS.c", 862; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_112 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 3584, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 868; // SELECT PLAYER SPRITE //
...
.LL167:
	...
	.dbg	line,	"include\routines_LEVELS.c", 873; //                                        H MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 874; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 876; // CHECK COLLISION LEFT WALL //

	.dbg	line,	"include\routines_LEVELS.c", 877; // IF THE PLAYER HAS NOT YET COLLIDED WITH A WALL //

	.dbg	line,	"include\routines_LEVELS.c", 878; //if(collision_side == FALSE)

	.dbg	line,	"include\routines_LEVELS.c", 879; //{

	.dbg	line,	"include\routines_LEVELS.c", 880; check_WALL_BL();
	__call		_check_WALL_BL
	...
	.dbg	line,	"include\routines_LEVELS.c", 884; check_WALL_TL();
	__call		_check_WALL_TL

	.dbg	line,	"include\routines_LEVELS.c", 886; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL169
	...
	.dbg	line,	"include\routines_LEVELS.c", 888; player_state = STATE_FALL;
	__st.umiq	9, _player_state
...
.LL169:
	...
	.dbg	line,	"include\routines_LEVELS.c", 893; sgx_map_pxl_x -= 2;
	__sub_st.wmiq	2, _sgx_map_pxl_x
...
.LL170:
	...
	.dbg	line,	"include\routines_LEVELS.c", 900; //                                        V MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 901; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 903; // UPDATE PLAYER Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 904; player_pos_y += TABLE_PLAYER_JUMP_V[player_index_jump];
.LL168:
	__ldx.umq	_player_index_jump
	__ld.bax	_TABLE_PLAYER_JUMP_V
	__add_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 907; // IF PLAYER GOES BELOW ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 908; if(player_pos_y >= PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__sge_w.wi	128
	__bfalse	.LL171
	...
	.dbg	line,	"include\routines_LEVELS.c", 910; // THE CAMERA MOVES //

	.dbg	line,	"include\routines_LEVELS.c", 911; // CALCULATE HOW MANY PIXELS THE CAMERA HAS TO MOVE DOWN //

	.dbg	line,	"include\routines_LEVELS.c", 912; camera_y_move = player_pos_y - PLAYER_BASE_Y_POS;
	__ld.wm		_player_pos_y
	__sub.wi	128
	__st.umq	__update_PLAYER_end - 5  /* camera_y_move */

	.dbg	line,	"include\routines_LEVELS.c", 913; sgx_map_pxl_y += camera_y_move;
	__ld.um		__update_PLAYER_end - 5  /* camera_y_move */
	__add_st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 915; // IF THE CAMERA HAS REACHED ITS MAX (LOWEST) POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 916; if(sgx_map_pxl_y > camera_max_y_position)
	__ld.wm		_sgx_map_pxl_y
	__ugt_w.wm	_camera_max_y_position
	__bfalse	.LL172
	...
	.dbg	line,	"include\routines_LEVELS.c", 918; // THE CAMERA CAN NOT MOVE LOWER //

	.dbg	line,	"include\routines_LEVELS.c", 919; sgx_map_pxl_y = camera_max_y_position;
	__ld.wm		_camera_max_y_position
	__st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 920; }

	.dbg	line,	"include\routines_LEVELS.c", 922; // THE PLAYER STAYS AT ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 923; player_pos_y = PLAYER_BASE_Y_POS;
.LL172:
	__st.wmiq	128, _player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 925; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 926; }

	.dbg	line,	"include\routines_LEVELS.c", 929; // UPDATE JUMP INDEX IN THE ARRAY //

	.dbg	line,	"include\routines_LEVELS.c", 930; // ARRAY MAX ENTRY : 34 //

	.dbg	line,	"include\routines_LEVELS.c", 931; if(player_index_jump < 34)
.LL171:
	__ld.umq	_player_index_jump
	__ult_b.uiq	34
	__bfalse	.LL173
	...
	.dbg	line,	"include\routines_LEVELS.c", 933; player_index_jump += 1;
	__add_st.umiq	1, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 934; }

	.dbg	line,	"include\routines_LEVELS.c", 937; // CHECK COLLISION WITH THE FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 938; check_FLOOR_L();
.LL173:
	__call		_check_FLOOR_L

	.dbg	line,	"include\routines_LEVELS.c", 941; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL174
	...
	.dbg	line,	"include\routines_LEVELS.c", 943; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 944; for(i=1; i<11 ; i++ )
	__st.umiq	1, __update_PLAYER_end - 4  /* i */
.LL175:
...
.LL177:
	...
	.dbg	line,	"include\routines_LEVELS.c", 946; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL179

	.dbg	line,	"include\routines_LEVELS.c", 947; {

	.dbg	line,	"include\routines_LEVELS.c", 948; check_BG( 11 , i);
	__ld.wi		11
	__pusharg.wr
...
.LL179:
	...
	.dbg	line,	"include\routines_LEVELS.c", 953; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 4  /* i */
	__pusharg.wr
...
.LL180:
	...
	.dbg	line,	"include\routines_LEVELS.c", 959; if(player_pos_y != PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__neq_w.wi	128
	__bfalse	.LL182
	...
	.dbg	line,	"include\routines_LEVELS.c", 961; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 4  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y
	...
	.dbg	line,	"include\routines_LEVELS.c", 964; else
	__bra		.LL183
.LL182:

	.dbg	line,	"include\routines_LEVELS.c", 965; {

	.dbg	line,	"include\routines_LEVELS.c", 966; sgx_map_pxl_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 4  /* i */
	__sub.wi	1
	__isub_st.wmq	_sgx_map_pxl_y
...
.LL178:
	...
	.dbg	line,	"include\routines_LEVELS.c", 973; // SET PLAYER SPRITE NEW POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 974; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 976; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 977; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 978; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 979; return;
	__bra		.LL98

	.dbg	line,	"include\routines_LEVELS.c", 980; }

	.dbg	line,	"include\routines_LEVELS.c", 983; // CHECK COLLISION WITH LADDERS //

	.dbg	line,	"include\routines_LEVELS.c", 984; if(player_index_jump > 4)
.LL174:
	__ld.umq	_player_index_jump
	__ugt_b.uiq	4
	__bfalse	.LL184
	...
	.dbg	line,	"include\routines_LEVELS.c", 986; check_LADDER( 16 , 16 );
	__ld.wi		16
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 988; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL185
	...
	.dbg	line,	"include\routines_LEVELS.c", 990; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 991; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 993; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 994; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 996; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 997; check_LADDER( 31 , 16 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 999; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL186
	...
	.dbg	line,	"include\routines_LEVELS.c", 1001; sgx_map_pxl_x += 8;
	__add_st.wmiq	8, _sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 1002; }

	.dbg	line,	"include\routines_LEVELS.c", 1004; /*else

	.dbg	line,	"include\routines_LEVELS.c", 1005; {

	.dbg	line,	"include\routines_LEVELS.c", 1006; // CHECK IF THE PLAYER STANDS LEFT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 1007; check_LADDER( 8 , 16 );

	.dbg	line,	"include\routines_LEVELS.c", 1009; if(map_blk_flag == TILE_LADDER)

	.dbg	line,	"include\routines_LEVELS.c", 1010; {

	.dbg	line,	"include\routines_LEVELS.c", 1011; sgx_map_pxl_x -= 8;

	.dbg	line,	"include\routines_LEVELS.c", 1012; }

	.dbg	line,	"include\routines_LEVELS.c", 1013; }*/

	.dbg	line,	"include\routines_LEVELS.c", 1015; player_counter_anim = 1;
.LL186:
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1016; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1017; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL185:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1022; // SET PLAYER SPRITE NEW POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1023; spr_y(player_pos_y);
.LL184:
	__ld.wm		_player_pos_y
	__call		_spr_y.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 1027; else if(player_state == STATE_CROUCH)
	__bra		.LL187
.LL166:
	__ld.umq	_player_state
	__equ_b.uiq	7
	...
	.dbg	line,	"include\routines_LEVELS.c", 1029; if(player_counter_anim == 1)
	__ld.umq	_player_counter_anim
	__equ_b.uiq	1
	__bfalse	.LL189
	...
	.dbg	line,	"include\routines_LEVELS.c", 1031; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_128 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 4096, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 1033; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1034; }

	.dbg	line,	"include\routines_LEVELS.c", 1036; recenter_CAMERA();
.LL189:
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 1037; }

	.dbg	line,	"include\routines_LEVELS.c", 1040; else if(player_state == STATE_FALL)
	__bra		.LL190
.LL188:
	__ld.umq	_player_state
	__equ_b.uiq	9
	...
	.dbg	line,	"include\routines_LEVELS.c", 1042; unsigned char i, camera_y_move;

	.dbg	line,	"include\routines_LEVELS.c", 1043; i = 1;
	...
	.dbg	line,	"include\routines_LEVELS.c", 1050; //                                        V MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 1051; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 1053; // UPDATE PLAYER Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1054; player_pos_y += 4;
	__add_st.wmiq	4, _player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 1057; // IF PLAYER GOES BELOW ITS BASE Y POSITION //
	...
	.dbg	line,	"include\routines_LEVELS.c", 1060; // THE CAMERA MOVES //

	.dbg	line,	"include\routines_LEVELS.c", 1061; // CALCULATE HOW MANY PIXELS THE CAMERA HAS TO MOVE DOWN //

	.dbg	line,	"include\routines_LEVELS.c", 1062; camera_y_move = player_pos_y - PLAYER_BASE_Y_POS;
	__ld.wm		_player_pos_y
	__sub.wi	128
	__st.umq	__update_PLAYER_end - 7  /* camera_y_move */

	.dbg	line,	"include\routines_LEVELS.c", 1063; sgx_map_pxl_y += camera_y_move;
	__ld.um		__update_PLAYER_end - 7  /* camera_y_move */
	__add_st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 1065; // IF THE CAMERA HAS REACHED ITS MAX (LOWEST) POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1066; if(sgx_map_pxl_y > camera_max_y_position)
	__ld.wm		_sgx_map_pxl_y
	__ugt_w.wm	_camera_max_y_position
	__bfalse	.LL193
	...
	.dbg	line,	"include\routines_LEVELS.c", 1068; // THE CAMERA CAN NOT MOVE LOWER //

	.dbg	line,	"include\routines_LEVELS.c", 1069; sgx_map_pxl_y = camera_max_y_position;
	__ld.wm		_camera_max_y_position
	__st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 1070; }

	.dbg	line,	"include\routines_LEVELS.c", 1072; // THE PLAYER STAYS AT ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1073; player_pos_y = PLAYER_BASE_Y_POS;
.LL193:
	__st.wmiq	128, _player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 1074; }

	.dbg	line,	"include\routines_LEVELS.c", 1077; // UPDATE JUMP INDEX IN THE ARRAY //

	.dbg	line,	"include\routines_LEVELS.c", 1078; // ARRAY MAX ENTRY : 34 //

	.dbg	line,	"include\routines_LEVELS.c", 1079; if(player_index_jump < 34)
.LL192:
	__ld.umq	_player_index_jump
	__ult_b.uiq	34
	__bfalse	.LL194
	...
	.dbg	line,	"include\routines_LEVELS.c", 1081; player_index_jump += 1;
	__add_st.umiq	1, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1082; }

	.dbg	line,	"include\routines_LEVELS.c", 1085; check_FLOOR_R();
.LL194:
	__call		_check_FLOOR_R

	.dbg	line,	"include\routines_LEVELS.c", 1088; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL195
	...
	.dbg	line,	"include\routines_LEVELS.c", 1090; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 1091; for(i=1; i<11 ; i++ )
	__st.umiq	1, __update_PLAYER_end - 6  /* i */
.LL196:
...
.LL198:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1093; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL200

	.dbg	line,	"include\routines_LEVELS.c", 1094; {

	.dbg	line,	"include\routines_LEVELS.c", 1095; check_BG( 20 , i);
	__ld.wi		20
	__pusharg.wr
...
.LL200:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1100; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 6  /* i */
	__pusharg.wr
...
.LL201:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1106; if(player_pos_y != PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__neq_w.wi	128
	__bfalse	.LL203
	...
	.dbg	line,	"include\routines_LEVELS.c", 1108; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 6  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y
	...
	.dbg	line,	"include\routines_LEVELS.c", 1111; else
	__bra		.LL204
.LL203:

	.dbg	line,	"include\routines_LEVELS.c", 1112; {

	.dbg	line,	"include\routines_LEVELS.c", 1113; sgx_map_pxl_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 6  /* i */
	__sub.wi	1
	__isub_st.wmq	_sgx_map_pxl_y
...
.LL204	.alias		.LL199
	...
	.dbg	line,	"include\routines_LEVELS.c", 1117; break;
	__bra		.LL199
...
.LL199:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1122; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 1124; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1125; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1126; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 1127; return;
	__bra		.LL98

	.dbg	line,	"include\routines_LEVELS.c", 1128; }

	.dbg	line,	"include\routines_LEVELS.c", 1131; check_FLOOR_L();
.LL195:
	__call		_check_FLOOR_L

	.dbg	line,	"include\routines_LEVELS.c", 1134; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL205
	...
	.dbg	line,	"include\routines_LEVELS.c", 1136; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 1137; for(i=1; i<11 ; i++ )
	__st.umiq	1, __update_PLAYER_end - 6  /* i */
.LL206:
	__ld.umq	__update_PLAYER_end - 6  /* i */
	__ult_b.uiq	11
...
.LL208:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1139; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL210

	.dbg	line,	"include\routines_LEVELS.c", 1140; {

	.dbg	line,	"include\routines_LEVELS.c", 1141; check_BG( 11 , i);
	__ld.wi		11
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 6  /* i */
	__pusharg.wr
...
.LL210:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1146; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 6  /* i */
	__pusharg.wr
...
.LL211:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1152; if(player_pos_y != PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__neq_w.wi	128
	__bfalse	.LL213
	...
	.dbg	line,	"include\routines_LEVELS.c", 1154; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 6  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y
...
.LL213:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1159; sgx_map_pxl_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 6  /* i */
	__sub.wi	1
	__isub_st.wmq	_sgx_map_pxl_y
...
.LL214	.alias		.LL209
	...
	.dbg	line,	"include\routines_LEVELS.c", 1163; break;
	__bra		.LL209
...
.LL209:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1168; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 1170; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1171; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1172; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 1173; return;
	__bra		.LL98

	.dbg	line,	"include\routines_LEVELS.c", 1174; }

	.dbg	line,	"include\routines_LEVELS.c", 1177; check_LADDER( 16 , 16 );
.LL205:
	__ld.wi		16
	__pusharg.wr
	__ld.wi		16
	...
	.dbg	line,	"include\routines_LEVELS.c", 1179; // IF PLAYER HITS THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 1180; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL215
	...
	.dbg	line,	"include\routines_LEVELS.c", 1182; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 1183; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 1185; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 1186; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 1188; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 1189; check_LADDER( 31 , 16 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1191; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL216
	...
	.dbg	line,	"include\routines_LEVELS.c", 1193; sgx_map_pxl_x += 8;
	__add_st.wmiq	8, _sgx_map_pxl_x
...
.LL216:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1197; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1198; player_state = STATE_HANG;
	__st.umiq	10, _player_state
	...
	.dbg	line,	"include\routines_LEVELS.c", 1203; spr_y(player_pos_y);
.LL215:
	__ld.wm		_player_pos_y
	__call		_spr_y.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 1207; else if(player_state == STATE_HANG)
	__bra		.LL217
.LL191:
	__ld.umq	_player_state
	__equ_b.uiq	10
	...
	.dbg	line,	"include\routines_LEVELS.c", 1211; if(player_counter_anim == 1)
	__ld.umq	_player_counter_anim
	__equ_b.uiq	1
	__bfalse	.LL219
	...
	.dbg	line,	"include\routines_LEVELS.c", 1213; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_144 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 4608, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 1215; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim
...
.LL219	.alias		.LL220
	...
	.dbg	line,	"include\routines_LEVELS.c", 1220; else if(player_state == STATE_CLIMB_UP)
	__bra		.LL220
.LL218:
	__ld.umq	_player_state
	__equ_b.uiq	11
	...
	.dbg	line,	"include\routines_LEVELS.c", 1222; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL222

	.dbg	line,	"include\routines_LEVELS.c", 1223; {

	.dbg	line,	"include\routines_LEVELS.c", 1224; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_160 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 1227; else if(player_counter_anim == 3)
	__bra		.LL223
.LL222:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1229; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_176 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 1232; else if(player_counter_anim == 6)
	__bra		.LL225
.LL224:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	6
	...
	.dbg	line,	"include\routines_LEVELS.c", 1234; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_192 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 1237; else if(player_counter_anim == 9)
	__bra		.LL227
.LL226:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	9
	...
	.dbg	line,	"include\routines_LEVELS.c", 1239; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_208 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 1242; else if(player_counter_anim == 12)
	__bra		.LL229
.LL228:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	12
	...
	.dbg	line,	"include\routines_LEVELS.c", 1244; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_192 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 6144, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1247; else if(player_counter_anim == 15)
	__bra		.LL231
.LL230:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	15
	...
	.dbg	line,	"include\routines_LEVELS.c", 1249; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_176 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 5632, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1253; player_counter_anim += 1;
.LL232:
.LL231:
.LL229:
.LL227:
...
.LL223:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1255; if(player_counter_anim == 17)
	__ld.umq	_player_counter_anim
	__equ_b.uiq	17
	__bfalse	.LL233
	...
	.dbg	line,	"include\routines_LEVELS.c", 1257; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1258; }

	.dbg	line,	"include\routines_LEVELS.c", 1260; recenter_CAMERA();
.LL233:
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 1261; }

	.dbg	line,	"include\routines_LEVELS.c", 1264; else if(player_state == STATE_CLIMB_DOWN)
	__bra		.LL234
.LL221:
	__ld.umq	_player_state
	__equ_b.uiq	12
	...
	.dbg	line,	"include\routines_LEVELS.c", 1268; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_176 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 5632, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1271; else if(player_counter_anim == 3)
	__bra		.LL237
.LL236:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	3
...
.LL238:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1278; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_208 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 6656, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1281; else if(player_counter_anim == 9)
	__bra		.LL241
.LL240:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	9
	...
	.dbg	line,	"include\routines_LEVELS.c", 1283; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_192 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 6144, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1286; else if(player_counter_anim == 12)
	__bra		.LL243
.LL242:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	12
	...
	.dbg	line,	"include\routines_LEVELS.c", 1288; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_176 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 5632, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1291; else if(player_counter_anim == 15)
	__bra		.LL245
.LL244:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	15
	...
	.dbg	line,	"include\routines_LEVELS.c", 1293; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_160 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 5120, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
...
.LL237:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1299; if(player_counter_anim == 17)
	__ld.umq	_player_counter_anim
	__equ_b.uiq	17
	__bfalse	.LL247
	...
	.dbg	line,	"include\routines_LEVELS.c", 1301; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1302; }

	.dbg	line,	"include\routines_LEVELS.c", 1304; recenter_CAMERA();
.LL247:
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 1305; }

	.dbg	line,	"include\routines_LEVELS.c", 1308; else if(player_state == STATE_JUMP_LADDER)
	__bra		.LL248
.LL235:
	__ld.umq	_player_state
	__equ_b.uiq	13
	...
	.dbg	line,	"include\routines_LEVELS.c", 1310; unsigned char i;

	.dbg	line,	"include\routines_LEVELS.c", 1311; i = 1;
	__st.umiq	1, __update_PLAYER_end - 8  /* i */

	.dbg	line,	"include\routines_LEVELS.c", 1314; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL250

	.dbg	line,	"include\routines_LEVELS.c", 1315; {

	.dbg	line,	"include\routines_LEVELS.c", 1316; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_112 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 3584, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1322; player_pos_y += TABLE_PLAYER_JUMP_V[player_index_jump];
.LL250:
	__ldx.umq	_player_index_jump
	__ld.bax	_TABLE_PLAYER_JUMP_V
	__add_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 1324; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 1325; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 1329; if(player_index_jump < 34)
	__ld.umq	_player_index_jump
	__ult_b.uiq	34
	__bfalse	.LL251
	...
	.dbg	line,	"include\routines_LEVELS.c", 1331; player_index_jump += 1;
	__add_st.umiq	1, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1332; }

	.dbg	line,	"include\routines_LEVELS.c", 1335; // CHECK COLLISION WITH FLOOR //
...
.LL251:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1338; check_FLOOR_R();
	__call		_check_FLOOR_R
...
.LL252:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1343; check_FLOOR_L();
	__call		_check_FLOOR_L

	.dbg	line,	"include\routines_LEVELS.c", 1344; }
.LL253:

	.dbg	line,	"include\routines_LEVELS.c", 1347; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL254
	...
	.dbg	line,	"include\routines_LEVELS.c", 1349; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 1350; for(i=1; i<11 ; i++ )
	__st.umiq	1, __update_PLAYER_end - 8  /* i */
.LL255:
...
.LL257:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1354; check_BG( 11 , i);
	__ld.wi		11
	__pusharg.wr
...
.LL259:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1359; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 8  /* i */
	__pusharg.wr
...
.LL260:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1363; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL261

	.dbg	line,	"include\routines_LEVELS.c", 1364; {

	.dbg	line,	"include\routines_LEVELS.c", 1365; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 1367; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 8  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 1368; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 1369; break;
	__bra		.LL258
...
.LL258:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1374; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1375; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1376; player_state = STATE_IDLE;
	__st.umiq	0, _player_state
	...
	.dbg	line,	"include\routines_LEVELS.c", 1381; if(player_index_jump > 18)
.LL254:
	__ld.umq	_player_index_jump
	__ugt_b.uiq	18
	__bfalse	.LL262
	...
	.dbg	line,	"include\routines_LEVELS.c", 1383; // CHECK COLLISION WITH LADDERS //

	.dbg	line,	"include\routines_LEVELS.c", 1384; check_LADDER( 16 , 8 );
	__ld.wi		16
	__pusharg.wr
	__ld.wi		8
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1386; // IF PLAYER HITS THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 1387; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL263
	...
	.dbg	line,	"include\routines_LEVELS.c", 1389; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 1390; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 1392; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 1393; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 1395; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 1396; check_LADDER( 31 , 8 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		8
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1398; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL264
	...
	.dbg	line,	"include\routines_LEVELS.c", 1400; sgx_map_pxl_x += 8;
	__add_st.wmiq	8, _sgx_map_pxl_x
...
.LL264:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1405; player_state = STATE_HANG;
	__st.umiq	10, _player_state
