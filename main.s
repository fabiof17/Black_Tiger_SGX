...
_palette_PLAYER:	.incpal		"res/palettes/palette_PLAYER.png"
	...
	.dbg	line,	"..\..\..\include\hucc\hucc-blkmap.h", 157; #endif // __HUCC__
	.dbg	line,	"..\..\..\include\hucc\hucc-blkmap.h", 159; #endif // _hucc_blkmap_h
	.dbg	line,	"include\routines_LEVELS.c", 13; int check_BG(signed char x_offset , signed char y_offset)
...
;***********************
	...
	.dbg	line,	"include\routines_LEVELS.c", 89; player_COLL_Y = player_pos_y + 32;//32
	__ld.wm		_player_pos_y
	__add.wi	32
...
;***********************
	...
	.dbg	line,	"include\routines_LEVELS.c", 103; player_COLL_Y = player_pos_y + 32;//32
	__ld.wm		_player_pos_y
	__add.wi	32
...
.LL11:
	...
	.dbg	line,	"include\routines_LEVELS.c", 203; void joypad_BUTTONS()
...
;***********************
	...
	.dbg	line,	"include\routines_LEVELS.c", 205; if(joytrg(JOYPAD_1) == JOY_I)
	__ld.uiq	0
	 _joytrg.1
	__equ_w.wi	1
	__bfalse	.LL20
	...
	.dbg	line,	"include\routines_LEVELS.c", 207; if(player_state == STATE_IDLE)
	__not.um	_player_state
	__bfalse	.LL21

	.dbg	line,	"include\routines_LEVELS.c", 208; {

	.dbg	line,	"include\routines_LEVELS.c", 209; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 211; player_state = STATE_JUMP;
	__st.umiq	4, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 212; }

	.dbg	line,	"include\routines_LEVELS.c", 215; else if(player_state == STATE_WALK)
	__bra		.LL22
.LL21:
	...
	.dbg	line,	"include\routines_LEVELS.c", 217; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim
	...
	.dbg	line,	"include\routines_LEVELS.c", 223; else if(player_state == STATE_HANG || player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__bra		.LL24
.LL23:
	__ld.umq	_player_state
	__equ_b.uiq	10
...
.LL27:
	...
	.dbg	line,	"include\routines_LEVELS.c", 225; if(joy(JOYPAD_1) & JOY_RIGHT)
	__ld.uiq	0
	 _joy.1
	__tand.wi	32
	__bfalse	.LL28
	...
	.dbg	line,	"include\routines_LEVELS.c", 229; player_state = STATE_JUMP_RIGHT;
	__st.umiq	5, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 230; }

	.dbg	line,	"include\routines_LEVELS.c", 232; else if(joy(JOYPAD_1) & JOY_LEFT)
	__bra		.LL29
.LL28:
	__ld.uiq	0
	 _joy.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 234; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 236; player_state = STATE_JUMP_LEFT;
	__st.umiq	6, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 237; }

	.dbg	line,	"include\routines_LEVELS.c", 239; else if(joy(JOYPAD_1) & JOY_UP)
	__bra		.LL31
.LL30:
	__ld.uiq	0
	 _joy.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 241; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 243; check_LADDER( 15 , 8 );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		8
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 245; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL33

	.dbg	line,	"include\routines_LEVELS.c", 246; {

	.dbg	line,	"include\routines_LEVELS.c", 247; player_state = STATE_JUMP_LADDER;
...
.LL19:
	...
	.dbg	line,	"include\routines_LEVELS.c", 255; void joypad_DIR()
...
;***********************
	...
	.dbg	line,	"include\routines_LEVELS.c", 258; //                                        NO DIR                                        //

	.dbg	line,	"include\routines_LEVELS.c", 259; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 261; if(! (joy(JOYPAD_1) & JOY_DIR_PRESSED) )
	__ld.uiq	0
	 _joy.1
	__nand.wi	240
	__bfalse	.LL35
	...
	.dbg	line,	"include\routines_LEVELS.c", 263; if(player_state == STATE_WALK || player_state == STATE_CROUCH)
	__ld.umq	_player_state
	__equ_b.uiq	1
	__btrue		.LL37
	__ld.umq	_player_state
...
.LL37:
	...
	.dbg	line,	"include\routines_LEVELS.c", 266; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 267; }

	.dbg	line,	"include\routines_LEVELS.c", 270; else if(player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__bra		.LL38
.LL36:
	__ld.umq	_player_state
	__equ_b.uiq	11
...
.LL40:
	...
	.dbg	line,	"include\routines_LEVELS.c", 272; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 273; player_state = STATE_HANG;
...
.LL38:
	...
	.dbg	line,	"include\routines_LEVELS.c", 279; //                                     RIGHT BUTTON                                     //

	.dbg	line,	"include\routines_LEVELS.c", 280; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 282; if(joy(JOYPAD_1) & JOY_RIGHT)
.LL35:
	__ld.uiq	0
	 _joy.1
	__tand.wi	32
	...
	.dbg	line,	"include\routines_LEVELS.c", 284; if(player_state == STATE_IDLE || player_state == STATE_WALK)
	__not.um	_player_state
	__btrue		.LL43
	__ld.umq	_player_state
	__equ_b.uiq	1
.LL43:
	...
	.dbg	line,	"include\routines_LEVELS.c", 286; player_axis = AXIS_RIGHT;
	__st.umiq	0, _player_axis

	.dbg	line,	"include\routines_LEVELS.c", 288; if(player_previous_axis != player_axis)
	...
	.dbg	line,	"include\routines_LEVELS.c", 290; player_previous_axis = player_axis;
	__ld.um		_player_axis
	__st.umq	_player_previous_axis

	.dbg	line,	"include\routines_LEVELS.c", 292; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 293; spr_ctrl(FLIP_MAS, NO_FLIP_X);
	__st.umiq	136, _al
	__ld.uiq	0
	__call		_spr_ctrl.2
	...
	.dbg	line,	"include\routines_LEVELS.c", 296; if(joy(JOYPAD_1) & JOY_DOWN)
.LL44:
	__ld.uiq	0
	 _joy.1
	__tand.wi	64
	...
	.dbg	line,	"include\routines_LEVELS.c", 298; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 299; player_state = STATE_CROUCH;
	__st.umiq	7, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 300; return;
	__bra		.LL34

	.dbg	line,	"include\routines_LEVELS.c", 301; }

	.dbg	line,	"include\routines_LEVELS.c", 303; player_state = STATE_WALK;
.LL45:
	__st.umiq	1, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 304; }

	.dbg	line,	"include\routines_LEVELS.c", 307; else if(player_state == STATE_JUMP || player_state == STATE_JUMP_LEFT || player_state == STATE_CROUCH || player_state == STATE_FALL || player_state == STATE_HANG)
	__bra		.LL46
.LL42:
	__ld.umq	_player_state
	__equ_b.uiq	4
...
.LL51:
	...
	.dbg	line,	"include\routines_LEVELS.c", 309; if(player_axis == AXIS_LEFT)
	...
	.dbg	line,	"include\routines_LEVELS.c", 311; player_axis = AXIS_RIGHT;
	__st.umiq	0, _player_axis

	.dbg	line,	"include\routines_LEVELS.c", 312; player_previous_axis = player_axis;
	__ld.um		_player_axis
	__st.umq	_player_previous_axis

	.dbg	line,	"include\routines_LEVELS.c", 314; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 315; spr_ctrl(FLIP_MAS, NO_FLIP_X);
	__st.umiq	136, _al
	__ld.uiq	0
	__call		_spr_ctrl.2
...
.LL52	.alias		.LL53
	...
	.dbg	line,	"include\routines_LEVELS.c", 320; else if(player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__bra		.LL53
.LL47:
	__ld.umq	_player_state
	__equ_b.uiq	11
...
.LL55:
	...
	.dbg	line,	"include\routines_LEVELS.c", 322; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 323; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL46	.alias		.LL56
	...
	.dbg	line,	"include\routines_LEVELS.c", 329; //                                     LEFT BUTTON                                      //

	.dbg	line,	"include\routines_LEVELS.c", 330; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 332; else if(joy(JOYPAD_1) & JOY_LEFT)
	__bra		.LL56
.LL41:
	__ld.uiq	0
	 _joy.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 334; if(player_state == STATE_IDLE || player_state == STATE_WALK)
	__not.um	_player_state
	__btrue		.LL59
	__ld.umq	_player_state
	__equ_b.uiq	1
.LL59:
	...
	.dbg	line,	"include\routines_LEVELS.c", 336; player_axis = AXIS_LEFT;
	__st.umiq	1, _player_axis

	.dbg	line,	"include\routines_LEVELS.c", 338; if(player_previous_axis != player_axis)
	__ld.umq	_player_previous_axis
	__neq_b.umq	_player_axis
	__bfalse	.LL60
	...
	.dbg	line,	"include\routines_LEVELS.c", 340; player_previous_axis = player_axis;
	__ld.um		_player_axis
	__st.umq	_player_previous_axis

	.dbg	line,	"include\routines_LEVELS.c", 342; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 343; spr_ctrl(FLIP_MAS, FLIP_X);
	__st.umiq	136, _al
	__ld.uiq	8
	__call		_spr_ctrl.2
	...
	.dbg	line,	"include\routines_LEVELS.c", 346; if(joy(JOYPAD_1) & JOY_DOWN)
.LL60:
	__ld.uiq	0
	 _joy.1
	__tand.wi	64
	...
	.dbg	line,	"include\routines_LEVELS.c", 349; player_state = STATE_CROUCH;
	__st.umiq	7, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 350; return;
	__bra		.LL34

	.dbg	line,	"include\routines_LEVELS.c", 351; }

	.dbg	line,	"include\routines_LEVELS.c", 353; player_state = STATE_WALK;
.LL61:
	__st.umiq	1, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 354; }

	.dbg	line,	"include\routines_LEVELS.c", 357; else if(player_state == STATE_JUMP || player_state == STATE_JUMP_RIGHT || player_state == STATE_CROUCH || player_state == STATE_FALL || player_state == STATE_HANG)
	__bra		.LL62
.LL58:
	__ld.umq	_player_state
	__equ_b.uiq	4
...
.LL67:
	...
	.dbg	line,	"include\routines_LEVELS.c", 359; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL68

	.dbg	line,	"include\routines_LEVELS.c", 360; {

	.dbg	line,	"include\routines_LEVELS.c", 361; player_axis = AXIS_LEFT;
	__st.umiq	1, _player_axis

	.dbg	line,	"include\routines_LEVELS.c", 362; player_previous_axis = player_axis;
	__ld.um		_player_axis
	__st.umq	_player_previous_axis
	...
	.dbg	line,	"include\routines_LEVELS.c", 365; spr_ctrl(FLIP_MAS, FLIP_X);
	__st.umiq	136, _al
	__ld.uiq	8
	__call		_spr_ctrl.2
...
.LL68	.alias		.LL69
	...
	.dbg	line,	"include\routines_LEVELS.c", 370; else if(player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__bra		.LL69
.LL63:
	__ld.umq	_player_state
	__equ_b.uiq	11
...
.LL71:
	...
	.dbg	line,	"include\routines_LEVELS.c", 372; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 373; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL62	.alias		.LL72
	...
	.dbg	line,	"include\routines_LEVELS.c", 379; //                                      UP BUTTON                                       //

	.dbg	line,	"include\routines_LEVELS.c", 380; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 382; else if(joy(JOYPAD_1) & JOY_UP)
	__bra		.LL72
.LL57:
	__ld.uiq	0
	 _joy.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 384; if(player_state == STATE_HANG || player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__ld.umq	_player_state
	__equ_b.uiq	10
	__btrue		.LL75
	__ld.umq	_player_state
...
.LL76:
	...
	.dbg	line,	"include\routines_LEVELS.c", 386; unsigned char i;

	.dbg	line,	"include\routines_LEVELS.c", 388; check_LADDER( 15 , 8 );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		8
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 390; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL77

	.dbg	line,	"include\routines_LEVELS.c", 391; {

	.dbg	line,	"include\routines_LEVELS.c", 392; for(i=1 ; i<3 ; i++)
...
.LL80:
	...
	.dbg	line,	"include\routines_LEVELS.c", 394; check_LADDER( 15 , 8 + i );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		8
	...
	.dbg	line,	"include\routines_LEVELS.c", 396; if(map_blk_flag == TILE_LADDER)
	...
	.dbg	line,	"include\routines_LEVELS.c", 398; sgx_map_pxl_y -= (2 - i);
	__ld.wi		2
	__sub.um	__joypad_DIR_end - 1  /* i */
	__isub_st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 399; break;
	__bra		.LL81
...
.LL81	.alias		.LL83
	...
	.dbg	line,	"include\routines_LEVELS.c", 404; else
	__bra		.LL83
.LL77:

	.dbg	line,	"include\routines_LEVELS.c", 405; {

	.dbg	line,	"include\routines_LEVELS.c", 406; sgx_map_pxl_y -= 2;
	__sub_st.wmiq	2, _sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 407; }
.LL83:

	.dbg	line,	"include\routines_LEVELS.c", 409; player_state = STATE_CLIMB_UP;
...
.LL74	.alias		.LL84
	...
	.dbg	line,	"include\routines_LEVELS.c", 415; //                                     DOWN BUTTON                                      //

	.dbg	line,	"include\routines_LEVELS.c", 416; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 418; else if(joy(JOYPAD_1) & JOY_DOWN)
	__bra		.LL84
.LL73:
	__ld.uiq	0
	 _joy.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 420; if(player_state == STATE_IDLE || player_state == STATE_WALK)
	__not.um	_player_state
	__btrue		.LL87
	__ld.umq	_player_state
	__equ_b.uiq	1
.LL87:
	...
	.dbg	line,	"include\routines_LEVELS.c", 422; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 423; player_state = STATE_CROUCH;
	__st.umiq	7, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 424; }

	.dbg	line,	"include\routines_LEVELS.c", 427; else if(player_state == STATE_HANG || player_state == STATE_CLIMB_UP || player_state == STATE_CLIMB_DOWN)
	__bra		.LL88
.LL86:
	__ld.umq	_player_state
	__equ_b.uiq	10
...
.LL91:
	...
	.dbg	line,	"include\routines_LEVELS.c", 429; unsigned char i;

	.dbg	line,	"include\routines_LEVELS.c", 431; check_LADDER( 15 , 10 );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		10
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 435; for(i=1 ; i<3 ; i++)
...
.LL95:
	...
	.dbg	line,	"include\routines_LEVELS.c", 437; check_LADDER( 15 , 22 + i );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		22
	...
	.dbg	line,	"include\routines_LEVELS.c", 439; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL97
	...
	.dbg	line,	"include\routines_LEVELS.c", 441; sgx_map_pxl_y += (2 - i);
	__ld.wi		2
	...
	.dbg	line,	"include\routines_LEVELS.c", 445; else
.LL97:

	.dbg	line,	"include\routines_LEVELS.c", 446; {

	.dbg	line,	"include\routines_LEVELS.c", 447; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_224 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 7168 + 512, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 449; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 450; player_index_jump = 0;
...
.LL96	.alias		.LL99
	...
	.dbg	line,	"include\routines_LEVELS.c", 456; else
	__bra		.LL99
.LL92:

	.dbg	line,	"include\routines_LEVELS.c", 457; {

	.dbg	line,	"include\routines_LEVELS.c", 458; sgx_map_pxl_y += 2;
	__add_st.wmiq	2, _sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 459; player_state = STATE_CLIMB_DOWN;
...
__joypad_DIR_end:
	...
	.dbg	line,	"include\routines_LEVELS.c", 472; void update_PLAYER()
...
;***********************
	...
	.dbg	line,	"include\routines_LEVELS.c", 474; if(player_state == STATE_IDLE)
	__not.um	_player_state
	__bfalse	.LL101

	.dbg	line,	"include\routines_LEVELS.c", 475; {

	.dbg	line,	"include\routines_LEVELS.c", 476; if(player_counter_anim == 1)
	...
	.dbg	line,	"include\routines_LEVELS.c", 478; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 480; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 481; }

	.dbg	line,	"include\routines_LEVELS.c", 483; recenter_CAMERA();
.LL102:
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 484; }

	.dbg	line,	"include\routines_LEVELS.c", 487; else if(player_state == STATE_WALK)
	__bra		.LL103
.LL101:
	__ld.umq	_player_state
	__equ_b.uiq	1
	...
	.dbg	line,	"include\routines_LEVELS.c", 489; recenter_CAMERA();
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 492; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL105

	.dbg	line,	"include\routines_LEVELS.c", 493; {

	.dbg	line,	"include\routines_LEVELS.c", 494; // CHECK COLLISION WITH FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 495; check_FLOOR_L();
	__call		_check_FLOOR_L

	.dbg	line,	"include\routines_LEVELS.c", 497; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL106

	.dbg	line,	"include\routines_LEVELS.c", 498; {

	.dbg	line,	"include\routines_LEVELS.c", 499; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 501; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 502; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 503; player_state = STATE_FALL;
	__st.umiq	9, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 504; }

	.dbg	line,	"include\routines_LEVELS.c", 508; // CHECK COLLISION WITH WALLS //

	.dbg	line,	"include\routines_LEVELS.c", 509; check_WALL_BR();
.LL106:
	__call		_check_WALL_BR

	.dbg	line,	"include\routines_LEVELS.c", 510; put_number(map_blk_flag,3,0,0);
	__ld.um		_map_blk_flag
	__st.wmq	_bx
	__st.umiq	3, _cl
	__st.umiq	0, _dil
	__st.umiq	0, _dih
	...
	.dbg	line,	"include\routines_LEVELS.c", 511; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL107

	.dbg	line,	"include\routines_LEVELS.c", 512; {

	.dbg	line,	"include\routines_LEVELS.c", 513; sgx_map_pxl_x += 2;
...
.LL107	.alias		.LL108
	...
	.dbg	line,	"include\routines_LEVELS.c", 518; else if(player_axis == AXIS_LEFT)
	__bra		.LL108
.LL105:
	__ld.umq	_player_axis
	__equ_b.uiq	1
	...
	.dbg	line,	"include\routines_LEVELS.c", 520; // CHECK COLLISION WITH FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 521; check_FLOOR_R();
	__call		_check_FLOOR_R

	.dbg	line,	"include\routines_LEVELS.c", 523; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL110

	.dbg	line,	"include\routines_LEVELS.c", 524; {

	.dbg	line,	"include\routines_LEVELS.c", 525; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 527; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 528; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 529; player_state = STATE_FALL;
	__st.umiq	9, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 530; }

	.dbg	line,	"include\routines_LEVELS.c", 533; // CHECK COLLISION WITH BG //

	.dbg	line,	"include\routines_LEVELS.c", 534; check_WALL_BL();
.LL110:
	__call		_check_WALL_BL

	.dbg	line,	"include\routines_LEVELS.c", 536; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL111

	.dbg	line,	"include\routines_LEVELS.c", 537; {

	.dbg	line,	"include\routines_LEVELS.c", 538; sgx_map_pxl_x -= 2;
...
.LL111:
	...
	.dbg	line,	"include\routines_LEVELS.c", 545; spr_set(player_id);
.LL109:
.LL108:
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 548; // UPDATE PLAYER TILES //

	.dbg	line,	"include\routines_LEVELS.c", 549; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL112

	.dbg	line,	"include\routines_LEVELS.c", 550; {

	.dbg	line,	"include\routines_LEVELS.c", 551; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 555; else if(player_counter_anim == 2)
	__bra		.LL113
.LL112:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	2
	...
	.dbg	line,	"include\routines_LEVELS.c", 557; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_1 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 561; else if(player_counter_anim == 5)
	__bra		.LL115
.LL114:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	5
	...
	.dbg	line,	"include\routines_LEVELS.c", 563; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_2 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 567; else if(player_counter_anim == 8)
	__bra		.LL117
.LL116:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	8
	...
	.dbg	line,	"include\routines_LEVELS.c", 569; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_3 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 573; else if(player_counter_anim == 11)
	__bra		.LL119
.LL118:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	11
	...
	.dbg	line,	"include\routines_LEVELS.c", 575; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 579; else if(player_counter_anim == 14)
	__bra		.LL121
.LL120:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	14
	...
	.dbg	line,	"include\routines_LEVELS.c", 581; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_4 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 585; else if(player_counter_anim == 17)
	__bra		.LL123
.LL122:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	17
	...
	.dbg	line,	"include\routines_LEVELS.c", 587; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_5 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 591; else if(player_counter_anim == 20)
	__bra		.LL125
.LL124:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	20
	...
	.dbg	line,	"include\routines_LEVELS.c", 593; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + OFFSET_PLAYER_WALK_6 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 597; else if(player_counter_anim == 22)
	__bra		.LL127
.LL126:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	22
	...
	.dbg	line,	"include\routines_LEVELS.c", 599; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 601; return;
	__bra		.LL100

	.dbg	line,	"include\routines_LEVELS.c", 602; }

	.dbg	line,	"include\routines_LEVELS.c", 605; player_counter_anim += 1;
.LL128:
.LL127:
.LL125:
.LL123:
...
.LL113:
	...
	.dbg	line,	"include\routines_LEVELS.c", 610; else if(player_state == STATE_JUMP)
	__bra		.LL129
.LL104:
	__ld.umq	_player_state
	__equ_b.uiq	4
	...
	.dbg	line,	"include\routines_LEVELS.c", 612; unsigned char i;

	.dbg	line,	"include\routines_LEVELS.c", 613; i = 1;
	__st.umiq	1, __update_PLAYER_end - 1  /* i */

	.dbg	line,	"include\routines_LEVELS.c", 616; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL131

	.dbg	line,	"include\routines_LEVELS.c", 617; {

	.dbg	line,	"include\routines_LEVELS.c", 618; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_112 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 3584, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 620; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 621; }

	.dbg	line,	"include\routines_LEVELS.c", 624; player_pos_y += TABLE_PLAYER_JUMP_V[player_index_jump];
.LL131:
	__ldx.umq	_player_index_jump
	__ld.bax	_TABLE_PLAYER_JUMP_V
	__add_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 626; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 627; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 631; if(player_index_jump < 34)
	...
	.dbg	line,	"include\routines_LEVELS.c", 633; player_index_jump += 1;
	__add_st.umiq	1, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 634; }

	.dbg	line,	"include\routines_LEVELS.c", 637; // CHECK COLLISION WITH FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 638; if(player_axis == AXIS_RIGHT)
.LL132:
	__not.um	_player_axis
	__bfalse	.LL133
	...
	.dbg	line,	"include\routines_LEVELS.c", 640; check_FLOOR_R();
	__call		_check_FLOOR_R

	.dbg	line,	"include\routines_LEVELS.c", 641; }

	.dbg	line,	"include\routines_LEVELS.c", 643; else
	__bra		.LL134
.LL133:

	.dbg	line,	"include\routines_LEVELS.c", 644; {

	.dbg	line,	"include\routines_LEVELS.c", 645; check_FLOOR_L();
	__call		_check_FLOOR_L

	.dbg	line,	"include\routines_LEVELS.c", 646; }
.LL134:

	.dbg	line,	"include\routines_LEVELS.c", 649; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL135
	...
	.dbg	line,	"include\routines_LEVELS.c", 651; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 652; for(i=1; i<11 ; i++ )
	__st.umiq	1, __update_PLAYER_end - 1  /* i */
.LL136:
...
.LL138:
	...
	.dbg	line,	"include\routines_LEVELS.c", 654; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL140

	.dbg	line,	"include\routines_LEVELS.c", 655; {

	.dbg	line,	"include\routines_LEVELS.c", 656; check_BG( 11 , i);
	__ld.wi		11
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 659; else
	__bra		.LL141
.LL140:

	.dbg	line,	"include\routines_LEVELS.c", 660; {

	.dbg	line,	"include\routines_LEVELS.c", 661; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 1  /* i */
	__pusharg.wr
...
.LL141:
	...
	.dbg	line,	"include\routines_LEVELS.c", 665; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL142

	.dbg	line,	"include\routines_LEVELS.c", 666; {

	.dbg	line,	"include\routines_LEVELS.c", 667; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 669; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 1  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 670; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 671; break;
	__bra		.LL139
...
.LL139:
	...
	.dbg	line,	"include\routines_LEVELS.c", 676; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 677; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 678; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 679; return;
	__bra		.LL100

	.dbg	line,	"include\routines_LEVELS.c", 680; }

	.dbg	line,	"include\routines_LEVELS.c", 683; // CHECK COLLISION WITH LADDERS //

	.dbg	line,	"include\routines_LEVELS.c", 684; check_LADDER( 16 , 16 );
.LL135:
	__ld.wi		16
	__pusharg.wr
	__ld.wi		16
	...
	.dbg	line,	"include\routines_LEVELS.c", 686; // IF PLAYER HITS THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 687; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL143
	...
	.dbg	line,	"include\routines_LEVELS.c", 689; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 690; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 692; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 693; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 695; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 696; check_LADDER( 31 , 16 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 698; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL144
	...
	.dbg	line,	"include\routines_LEVELS.c", 700; sgx_map_pxl_x += 8;
...
.LL144:
	...
	.dbg	line,	"include\routines_LEVELS.c", 704; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 705; jump_ladder = TRUE;
	__st.umiq	1, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 706; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL143	.alias		.LL145
	...
	.dbg	line,	"include\routines_LEVELS.c", 711; else if(player_state == STATE_JUMP_RIGHT)
	__bra		.LL145
.LL130:
	__ld.umq	_player_state
	__equ_b.uiq	5
	...
	.dbg	line,	"include\routines_LEVELS.c", 713; unsigned char i, camera_y_move;

	.dbg	line,	"include\routines_LEVELS.c", 714; i = 1;
	__st.umiq	1, __update_PLAYER_end - 2  /* i */

	.dbg	line,	"include\routines_LEVELS.c", 717; // UPDATE PLAYER TILES //

	.dbg	line,	"include\routines_LEVELS.c", 718; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL147

	.dbg	line,	"include\routines_LEVELS.c", 719; {

	.dbg	line,	"include\routines_LEVELS.c", 720; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_112 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 3584, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 722; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 723; }

	.dbg	line,	"include\routines_LEVELS.c", 726; // SELECT PLAYER SPRITE //

	.dbg	line,	"include\routines_LEVELS.c", 727; spr_set(player_id);
.LL147:
	__ld.umq	_player_id
	__call		_spr_set.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 731; //                                        H MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 732; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 734; check_WALL_BR();
	__call		_check_WALL_BR

	.dbg	line,	"include\routines_LEVELS.c", 736; if(map_blk_flag != TILE_BG)
	__ld.umq	_map_blk_flag
	__neq_b.uiq	1
	__bfalse	.LL148
	...
	.dbg	line,	"include\routines_LEVELS.c", 738; check_WALL_TR();
	__call		_check_WALL_TR

	.dbg	line,	"include\routines_LEVELS.c", 740; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL149
	...
	.dbg	line,	"include\routines_LEVELS.c", 742; check_BG( 15 , -16 );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		-16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 744; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL150

	.dbg	line,	"include\routines_LEVELS.c", 745; {

	.dbg	line,	"include\routines_LEVELS.c", 746; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 747; player_index_fall = 0;
	__st.umiq	0, _player_index_fall

	.dbg	line,	"include\routines_LEVELS.c", 748; player_state = STATE_FALL;
	__st.umiq	9, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 749; //put_number(8,1,0,0);

	.dbg	line,	"include\routines_LEVELS.c", 750; return;
	__bra		.LL100
...
.LL150	.alias		.LL151
	...
	.dbg	line,	"include\routines_LEVELS.c", 754; else
	__bra		.LL151
.LL149:

	.dbg	line,	"include\routines_LEVELS.c", 755; {

	.dbg	line,	"include\routines_LEVELS.c", 756; sgx_map_pxl_x += 2;
	__add_st.wmiq	2, _sgx_map_pxl_x
...
.LL151	.alias		.LL152
	...
	.dbg	line,	"include\routines_LEVELS.c", 760; else
	__bra		.LL152
.LL148:

	.dbg	line,	"include\routines_LEVELS.c", 761; {

	.dbg	line,	"include\routines_LEVELS.c", 762; check_BG( 15 , -16 );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		-16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 764; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL153

	.dbg	line,	"include\routines_LEVELS.c", 765; {

	.dbg	line,	"include\routines_LEVELS.c", 766; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 767; player_index_fall = 0;
	__st.umiq	0, _player_index_fall

	.dbg	line,	"include\routines_LEVELS.c", 768; player_state = STATE_FALL;
	__st.umiq	9, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 769; //put_number(map_blk_flag,1,0,1);

	.dbg	line,	"include\routines_LEVELS.c", 770; return;
	__bra		.LL100
...
.LL152:
	...
	.dbg	line,	"include\routines_LEVELS.c", 776; //                                        V MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 777; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 779; // UPDATE PLAYER Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 780; if(jump_ladder == FALSE)
	__not.um	_jump_ladder
	__bfalse	.LL154

	.dbg	line,	"include\routines_LEVELS.c", 781; {

	.dbg	line,	"include\routines_LEVELS.c", 782; player_pos_y += TABLE_PLAYER_JUMP_V[player_index_jump];
	__ldx.umq	_player_index_jump
	__ld.bax	_TABLE_PLAYER_JUMP_V
	__add_st.wmq	_player_pos_y
	...
	.dbg	line,	"include\routines_LEVELS.c", 785; else
	__bra		.LL155
.LL154:

	.dbg	line,	"include\routines_LEVELS.c", 786; {

	.dbg	line,	"include\routines_LEVELS.c", 787; player_pos_y += TABLE_PLAYER_JUMP_LADDER[player_index_jump];
	__ldx.umq	_player_index_jump
...
.LL155:
	...
	.dbg	line,	"include\routines_LEVELS.c", 792; // IF PLAYER GOES BELOW ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 793; if(player_pos_y >= PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__sge_w.wi	128
	__bfalse	.LL156
	...
	.dbg	line,	"include\routines_LEVELS.c", 795; // THE CAMERA MOVES //

	.dbg	line,	"include\routines_LEVELS.c", 796; // CALCULATE HOW MANY PIXELS THE CAMERA HAS TO MOVE DOWN //

	.dbg	line,	"include\routines_LEVELS.c", 797; camera_y_move = player_pos_y - PLAYER_BASE_Y_POS;
	__ld.wm		_player_pos_y
	__sub.wi	128
	__st.umq	__update_PLAYER_end - 3  /* camera_y_move */

	.dbg	line,	"include\routines_LEVELS.c", 798; sgx_map_pxl_y += camera_y_move;
	__ld.um		__update_PLAYER_end - 3  /* camera_y_move */
	__add_st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 800; // IF THE CAMERA HAS REACHED ITS MAX (LOWEST) POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 801; if(sgx_map_pxl_y > camera_max_y_position)
	__ld.wm		_sgx_map_pxl_y
	...
	.dbg	line,	"include\routines_LEVELS.c", 803; // THE CAMERA CAN NOT MOVE LOWER //

	.dbg	line,	"include\routines_LEVELS.c", 804; sgx_map_pxl_y = camera_max_y_position;
	__ld.wm		_camera_max_y_position
	__st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 805; }

	.dbg	line,	"include\routines_LEVELS.c", 807; // THE PLAYER STAYS AT ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 808; player_pos_y = PLAYER_BASE_Y_POS;
.LL157:
	__st.wmiq	128, _player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 810; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 811; }

	.dbg	line,	"include\routines_LEVELS.c", 814; // UPDATE JUMP INDEX IN THE ARRAY //

	.dbg	line,	"include\routines_LEVELS.c", 815; if(player_index_jump < jump_max_index)
.LL156:
	__ld.umq	_player_index_jump
	...
	.dbg	line,	"include\routines_LEVELS.c", 817; player_index_jump += 1;
	__add_st.umiq	1, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 818; }

	.dbg	line,	"include\routines_LEVELS.c", 821; // CHECK COLLISION WITH THE FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 822; check_FLOOR_L();
.LL158:
	__call		_check_FLOOR_L
...
.LL162:
	...
	.dbg	line,	"include\routines_LEVELS.c", 832; check_BG( 11 , i);
	__ld.wi		11
	__pusharg.wr
...
.LL164:
	...
	.dbg	line,	"include\routines_LEVELS.c", 837; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 2  /* i */
	__pusharg.wr
...
.LL165:
	...
	.dbg	line,	"include\routines_LEVELS.c", 841; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL166
	...
	.dbg	line,	"include\routines_LEVELS.c", 845; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 2  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y
...
.LL167:
	...
	.dbg	line,	"include\routines_LEVELS.c", 850; sgx_map_pxl_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 2  /* i */
	__sub.wi	1
	__isub_st.wmq	_sgx_map_pxl_y
...
.LL168	.alias		.LL163
	...
	.dbg	line,	"include\routines_LEVELS.c", 853; break;
	__bra		.LL163
...
.LL163:
	...
	.dbg	line,	"include\routines_LEVELS.c", 857; // SET PLAYER SPRITE NEW POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 858; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 860; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 861; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 862; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 863; jump_max_index = 34;
	__st.umiq	34, _jump_max_index

	.dbg	line,	"include\routines_LEVELS.c", 864; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 865; return;
	__bra		.LL100

	.dbg	line,	"include\routines_LEVELS.c", 866; }

	.dbg	line,	"include\routines_LEVELS.c", 869; // CHECK COLLISION WITH LADDERS //

	.dbg	line,	"include\routines_LEVELS.c", 870; if(player_index_jump > 4)
.LL159:
	__ld.umq	_player_index_jump
	__ugt_b.uiq	4
	__bfalse	.LL169
	...
	.dbg	line,	"include\routines_LEVELS.c", 872; check_LADDER( 16 , 16 );
	__ld.wi		16
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 874; // IF PLAYER HITS THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 875; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL170
	...
	.dbg	line,	"include\routines_LEVELS.c", 877; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 878; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 880; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 881; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 883; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 884; check_LADDER( 31 , 16 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 886; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL171
	...
	.dbg	line,	"include\routines_LEVELS.c", 888; sgx_map_pxl_x += 8;
	__add_st.wmiq	8, _sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 889; }

	.dbg	line,	"include\routines_LEVELS.c", 891; player_counter_anim = 1;
.LL171:
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 892; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 893; jump_ladder = TRUE;
	__st.umiq	1, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 894; jump_max_index = 29;
	__st.umiq	29, _jump_max_index

	.dbg	line,	"include\routines_LEVELS.c", 895; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL170:
	...
	.dbg	line,	"include\routines_LEVELS.c", 900; // SET PLAYER SPRITE NEW POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 901; spr_y(player_pos_y);
.LL169:
	__ld.wm		_player_pos_y
	__call		_spr_y.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 905; else if(player_state == STATE_JUMP_LEFT)
	__bra		.LL172
.LL146:
	__ld.umq	_player_state
	__equ_b.uiq	6
	...
	.dbg	line,	"include\routines_LEVELS.c", 907; unsigned char i, camera_y_move;

	.dbg	line,	"include\routines_LEVELS.c", 908; i = 1;
	__st.umiq	1, __update_PLAYER_end - 4  /* i */

	.dbg	line,	"include\routines_LEVELS.c", 911; // UPDATE PLAYER TILES //

	.dbg	line,	"include\routines_LEVELS.c", 912; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL174

	.dbg	line,	"include\routines_LEVELS.c", 913; {

	.dbg	line,	"include\routines_LEVELS.c", 914; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_112 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 3584, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 916; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 917; }

	.dbg	line,	"include\routines_LEVELS.c", 920; // SELECT PLAYER SPRITE //
...
.LL174:
	...
	.dbg	line,	"include\routines_LEVELS.c", 925; //                                        H MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 926; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 928; check_WALL_BL();
	__call		_check_WALL_BL

	.dbg	line,	"include\routines_LEVELS.c", 930; if(map_blk_flag != TILE_BG)
	__ld.umq	_map_blk_flag
	__neq_b.uiq	1
	__bfalse	.LL175
	...
	.dbg	line,	"include\routines_LEVELS.c", 932; check_WALL_TL();
	__call		_check_WALL_TL

	.dbg	line,	"include\routines_LEVELS.c", 934; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL176
	...
	.dbg	line,	"include\routines_LEVELS.c", 936; check_BG( 15 , -16 );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		-16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 938; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL177

	.dbg	line,	"include\routines_LEVELS.c", 939; {

	.dbg	line,	"include\routines_LEVELS.c", 940; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 941; player_index_fall = 0;
	__st.umiq	0, _player_index_fall

	.dbg	line,	"include\routines_LEVELS.c", 942; player_state = STATE_FALL;
	__st.umiq	9, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 943; return;
	__bra		.LL100
...
.LL177	.alias		.LL178
	...
	.dbg	line,	"include\routines_LEVELS.c", 947; else
	__bra		.LL178
.LL176:

	.dbg	line,	"include\routines_LEVELS.c", 948; {

	.dbg	line,	"include\routines_LEVELS.c", 949; sgx_map_pxl_x -= 2;
	__sub_st.wmiq	2, _sgx_map_pxl_x
...
.LL178	.alias		.LL179
	...
	.dbg	line,	"include\routines_LEVELS.c", 953; else
	__bra		.LL179
.LL175:

	.dbg	line,	"include\routines_LEVELS.c", 954; {

	.dbg	line,	"include\routines_LEVELS.c", 955; check_BG( 15 , -16 );
	__ld.wi		15
	__pusharg.wr
	__ld.wi		-16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 957; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL180

	.dbg	line,	"include\routines_LEVELS.c", 958; {

	.dbg	line,	"include\routines_LEVELS.c", 959; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 960; player_index_fall = 0;
	__st.umiq	0, _player_index_fall

	.dbg	line,	"include\routines_LEVELS.c", 961; player_state = STATE_FALL;
	__st.umiq	9, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 962; return;
	__bra		.LL100
...
.LL179:
	...
	.dbg	line,	"include\routines_LEVELS.c", 968; //                                        V MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 969; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 971; // UPDATE PLAYER Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 972; if(jump_ladder == FALSE)
	__not.um	_jump_ladder
	__bfalse	.LL181

	.dbg	line,	"include\routines_LEVELS.c", 973; {

	.dbg	line,	"include\routines_LEVELS.c", 974; player_pos_y += TABLE_PLAYER_JUMP_V[player_index_jump];
	__ldx.umq	_player_index_jump
	__ld.bax	_TABLE_PLAYER_JUMP_V
	__add_st.wmq	_player_pos_y
	...
	.dbg	line,	"include\routines_LEVELS.c", 977; else
	__bra		.LL182
.LL181:

	.dbg	line,	"include\routines_LEVELS.c", 978; {

	.dbg	line,	"include\routines_LEVELS.c", 979; player_pos_y += TABLE_PLAYER_JUMP_LADDER[player_index_jump];
	__ldx.umq	_player_index_jump
	__ld.bax	_TABLE_PLAYER_JUMP_LADDER
	__add_st.wmq	_player_pos_y
...
.LL182:
	...
	.dbg	line,	"include\routines_LEVELS.c", 983; // IF PLAYER GOES BELOW ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 984; if(player_pos_y >= PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__sge_w.wi	128
	__bfalse	.LL183
	...
	.dbg	line,	"include\routines_LEVELS.c", 986; // THE CAMERA MOVES //

	.dbg	line,	"include\routines_LEVELS.c", 987; // CALCULATE HOW MANY PIXELS THE CAMERA HAS TO MOVE DOWN //

	.dbg	line,	"include\routines_LEVELS.c", 988; camera_y_move = player_pos_y - PLAYER_BASE_Y_POS;
	__ld.wm		_player_pos_y
	__sub.wi	128
	__st.umq	__update_PLAYER_end - 5  /* camera_y_move */

	.dbg	line,	"include\routines_LEVELS.c", 989; sgx_map_pxl_y += camera_y_move;
	__ld.um		__update_PLAYER_end - 5  /* camera_y_move */
	__add_st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 991; // IF THE CAMERA HAS REACHED ITS MAX (LOWEST) POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 992; if(sgx_map_pxl_y > camera_max_y_position)
	__ld.wm		_sgx_map_pxl_y
	__ugt_w.wm	_camera_max_y_position
	__bfalse	.LL184
	...
	.dbg	line,	"include\routines_LEVELS.c", 994; // THE CAMERA CAN NOT MOVE LOWER //

	.dbg	line,	"include\routines_LEVELS.c", 995; sgx_map_pxl_y = camera_max_y_position;
	__ld.wm		_camera_max_y_position
	__st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 996; }

	.dbg	line,	"include\routines_LEVELS.c", 998; // THE PLAYER STAYS AT ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 999; player_pos_y = PLAYER_BASE_Y_POS;
.LL184:
	__st.wmiq	128, _player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 1001; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 1002; }

	.dbg	line,	"include\routines_LEVELS.c", 1005; // UPDATE JUMP INDEX IN THE ARRAY //

	.dbg	line,	"include\routines_LEVELS.c", 1006; if(player_index_jump < jump_max_index)
.LL183:
	__ld.umq	_player_index_jump
	__ult_b.umq	_jump_max_index
	__bfalse	.LL185
	...
	.dbg	line,	"include\routines_LEVELS.c", 1008; player_index_jump += 1;
	__add_st.umiq	1, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1009; }

	.dbg	line,	"include\routines_LEVELS.c", 1012; // CHECK COLLISION WITH THE FLOOR //

	.dbg	line,	"include\routines_LEVELS.c", 1013; check_FLOOR_R();
.LL185:
	__call		_check_FLOOR_R

	.dbg	line,	"include\routines_LEVELS.c", 1016; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL186
	...
	.dbg	line,	"include\routines_LEVELS.c", 1018; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 1019; for(i=1; i<11 ; i++ )
	__st.umiq	1, __update_PLAYER_end - 4  /* i */
.LL187:
...
.LL189:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1021; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL191

	.dbg	line,	"include\routines_LEVELS.c", 1022; {

	.dbg	line,	"include\routines_LEVELS.c", 1023; check_BG( 11 , i);
	__ld.wi		11
	__pusharg.wr
...
.LL191:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1028; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 4  /* i */
	__pusharg.wr
...
.LL192:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1034; if(player_pos_y != PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__neq_w.wi	128
	__bfalse	.LL194
	...
	.dbg	line,	"include\routines_LEVELS.c", 1036; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 4  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y
	...
	.dbg	line,	"include\routines_LEVELS.c", 1039; else
	__bra		.LL195
.LL194:

	.dbg	line,	"include\routines_LEVELS.c", 1040; {

	.dbg	line,	"include\routines_LEVELS.c", 1041; sgx_map_pxl_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 4  /* i */
	__sub.wi	1
	__isub_st.wmq	_sgx_map_pxl_y
...
.LL190:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1048; // SET PLAYER SPRITE NEW POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1049; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 1051; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1052; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1053; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 1054; jump_max_index = 34;
	__st.umiq	34, _jump_max_index

	.dbg	line,	"include\routines_LEVELS.c", 1055; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 1056; return;
	__bra		.LL100

	.dbg	line,	"include\routines_LEVELS.c", 1057; }

	.dbg	line,	"include\routines_LEVELS.c", 1060; // CHECK COLLISION WITH LADDERS //

	.dbg	line,	"include\routines_LEVELS.c", 1061; if(player_index_jump > 4)
.LL186:
	__ld.umq	_player_index_jump
	__ugt_b.uiq	4
	__bfalse	.LL196
	...
	.dbg	line,	"include\routines_LEVELS.c", 1063; check_LADDER( 16 , 16 );
	__ld.wi		16
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1065; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL197
	...
	.dbg	line,	"include\routines_LEVELS.c", 1067; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 1068; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 1070; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 1071; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 1073; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 1074; check_LADDER( 31 , 16 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1076; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL198
	...
	.dbg	line,	"include\routines_LEVELS.c", 1078; sgx_map_pxl_x += 8;
	__add_st.wmiq	8, _sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 1079; }

	.dbg	line,	"include\routines_LEVELS.c", 1081; player_counter_anim = 1;
.LL198:
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1082; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1083; jump_ladder = TRUE;
	__st.umiq	1, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 1084; jump_max_index = 29;
	__st.umiq	29, _jump_max_index

	.dbg	line,	"include\routines_LEVELS.c", 1085; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL197:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1090; // SET PLAYER SPRITE NEW POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1091; spr_y(player_pos_y);
.LL196:
	__ld.wm		_player_pos_y
	__call		_spr_y.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 1095; else if(player_state == STATE_CROUCH)
	__bra		.LL199
.LL173:
	__ld.umq	_player_state
	__equ_b.uiq	7
	...
	.dbg	line,	"include\routines_LEVELS.c", 1097; if(player_counter_anim == 1)
	__ld.umq	_player_counter_anim
	__equ_b.uiq	1
	__bfalse	.LL201
	...
	.dbg	line,	"include\routines_LEVELS.c", 1099; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_128 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 4096, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 1101; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1102; }

	.dbg	line,	"include\routines_LEVELS.c", 1104; recenter_CAMERA();
.LL201:
	__call		_recenter_CAMERA
...
.LL200:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1110; unsigned char i, camera_y_move;

	.dbg	line,	"include\routines_LEVELS.c", 1111; i = 1;
	__st.umiq	1, __update_PLAYER_end - 6  /* i */

	.dbg	line,	"include\routines_LEVELS.c", 1114; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 1117; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 1118; //                                        V MOVE                                        //

	.dbg	line,	"include\routines_LEVELS.c", 1119; //--------------------------------------------------------------------------------------//

	.dbg	line,	"include\routines_LEVELS.c", 1121; // UPDATE PLAYER Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1122; player_pos_y += TABLE_PLAYER_FALL[player_index_fall];
	__ldx.umq	_player_index_fall
	__ld.bax	_TABLE_PLAYER_FALL
	__add_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 1125; // IF PLAYER GOES BELOW ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1126; if(player_pos_y >= PLAYER_BASE_Y_POS)
	__ld.wm		_player_pos_y
	__sge_w.wi	128
	__bfalse	.LL204
	...
	.dbg	line,	"include\routines_LEVELS.c", 1128; // THE CAMERA MOVES //

	.dbg	line,	"include\routines_LEVELS.c", 1129; // CALCULATE HOW MANY PIXELS THE CAMERA HAS TO MOVE DOWN //

	.dbg	line,	"include\routines_LEVELS.c", 1130; camera_y_move = player_pos_y - PLAYER_BASE_Y_POS;
	__ld.wm		_player_pos_y
	__sub.wi	128
	__st.umq	__update_PLAYER_end - 7  /* camera_y_move */

	.dbg	line,	"include\routines_LEVELS.c", 1131; sgx_map_pxl_y += camera_y_move;
	__ld.um		__update_PLAYER_end - 7  /* camera_y_move */
	__add_st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 1133; // IF THE CAMERA HAS REACHED ITS MAX (LOWEST) POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1134; if(sgx_map_pxl_y > camera_max_y_position)
	__ld.wm		_sgx_map_pxl_y
	__ugt_w.wm	_camera_max_y_position
	__bfalse	.LL205
	...
	.dbg	line,	"include\routines_LEVELS.c", 1136; // THE CAMERA CAN NOT MOVE LOWER //

	.dbg	line,	"include\routines_LEVELS.c", 1137; sgx_map_pxl_y = camera_max_y_position;
	__ld.wm		_camera_max_y_position
	__st.wmq	_sgx_map_pxl_y

	.dbg	line,	"include\routines_LEVELS.c", 1138; }

	.dbg	line,	"include\routines_LEVELS.c", 1140; // THE PLAYER STAYS AT ITS BASE Y POSITION //

	.dbg	line,	"include\routines_LEVELS.c", 1141; player_pos_y = PLAYER_BASE_Y_POS;
.LL205:
	__st.wmiq	128, _player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 1142; }

	.dbg	line,	"include\routines_LEVELS.c", 1145; // UPDATE JUMP INDEX IN THE ARRAY //

	.dbg	line,	"include\routines_LEVELS.c", 1146; // ARRAY MAX ENTRY : 20//

	.dbg	line,	"include\routines_LEVELS.c", 1147; if(player_index_fall < 20)
.LL204:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1149; player_index_fall += 1;
	__add_st.umiq	1, _player_index_fall

	.dbg	line,	"include\routines_LEVELS.c", 1150; }

	.dbg	line,	"include\routines_LEVELS.c", 1153; //check_FLOOR_R();

	.dbg	line,	"include\routines_LEVELS.c", 1154; check_BG( 15 , 0);
.LL206:
	__ld.wi		15
	__pusharg.wr
	__ld.wi		0
	...
	.dbg	line,	"include\routines_LEVELS.c", 1159; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 1160; for(i=1; i<11 ; i++ )
	__st.umiq	1, __update_PLAYER_end - 6  /* i */
.LL208:
...
.LL210:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1162; //if(player_axis == AXIS_RIGHT)

	.dbg	line,	"include\routines_LEVELS.c", 1163; //{

	.dbg	line,	"include\routines_LEVELS.c", 1164; check_BG( 15 , i);//20
	__ld.wi		15
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1169; check_BG( 10 , i);

	.dbg	line,	"include\routines_LEVELS.c", 1170; }*/

	.dbg	line,	"include\routines_LEVELS.c", 1173; if(map_blk_flag == TILE_EMPTY)
	__not.um	_map_blk_flag
	__bfalse	.LL212
	...
	.dbg	line,	"include\routines_LEVELS.c", 1177; player_pos_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 6  /* i */
	__sub.wi	1
	__isub_st.wmq	_player_pos_y
...
.LL213:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1182; sgx_map_pxl_y -= (i - 1);
	__ld.um		__update_PLAYER_end - 6  /* i */
	__sub.wi	1
	__isub_st.wmq	_sgx_map_pxl_y
...
.LL214	.alias		.LL211
	...
	.dbg	line,	"include\routines_LEVELS.c", 1186; break;
	__bra		.LL211
...
.LL211:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1191; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 1193; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim
	...
	.dbg	line,	"include\routines_LEVELS.c", 1196; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 1197; jump_max_index = 34;
	__st.umiq	34, _jump_max_index

	.dbg	line,	"include\routines_LEVELS.c", 1198; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 1199; return;
	__bra		.LL100

	.dbg	line,	"include\routines_LEVELS.c", 1200; }

	.dbg	line,	"include\routines_LEVELS.c", 1203; check_LADDER( 16 , 16 );
.LL207:
	__ld.wi		16
	__pusharg.wr
	__ld.wi		16
	...
	.dbg	line,	"include\routines_LEVELS.c", 1205; // IF PLAYER HITS THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 1206; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL215
	...
	.dbg	line,	"include\routines_LEVELS.c", 1208; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 1209; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 1211; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 1212; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 1214; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 1215; check_LADDER( 31 , 16 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		16
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1217; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL216
	...
	.dbg	line,	"include\routines_LEVELS.c", 1219; sgx_map_pxl_x += 8;
	__add_st.wmiq	8, _sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 1220; }

	.dbg	line,	"include\routines_LEVELS.c", 1222; player_counter_anim = 1;
.LL216:
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1223; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1224; player_index_fall = 0;
	__st.umiq	0, _player_index_fall
	...
	.dbg	line,	"include\routines_LEVELS.c", 1228; return;
	__bra		.LL100

	.dbg	line,	"include\routines_LEVELS.c", 1229; }

	.dbg	line,	"include\routines_LEVELS.c", 1232; spr_y(player_pos_y);
.LL215:
	__ld.wm		_player_pos_y
	__call		_spr_y.1
	...
	.dbg	line,	"include\routines_LEVELS.c", 1236; else if(player_state == STATE_HANG)
	__bra		.LL217
.LL203:
	__ld.umq	_player_state
	__equ_b.uiq	10
	...
	.dbg	line,	"include\routines_LEVELS.c", 1238; recenter_CAMERA();
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 1240; if(player_counter_anim == 1)
	__ld.umq	_player_counter_anim
	__equ_b.uiq	1
	__bfalse	.LL219
	...
	.dbg	line,	"include\routines_LEVELS.c", 1242; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_144 , TILES_16);
	__st.wmiq	18432, _di
...
.LL219	.alias		.LL220
	...
	.dbg	line,	"include\routines_LEVELS.c", 1249; else if(player_state == STATE_CLIMB_UP)
	__bra		.LL220
.LL218:
	__ld.umq	_player_state
	__equ_b.uiq	11
	...
	.dbg	line,	"include\routines_LEVELS.c", 1251; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL222

	.dbg	line,	"include\routines_LEVELS.c", 1252; {

	.dbg	line,	"include\routines_LEVELS.c", 1253; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_160 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 1256; else if(player_counter_anim == 3)
	__bra		.LL223
.LL222:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1258; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_176 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 1261; else if(player_counter_anim == 6)
	__bra		.LL225
.LL224:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	6
	...
	.dbg	line,	"include\routines_LEVELS.c", 1263; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_192 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 1266; else if(player_counter_anim == 9)
	__bra		.LL227
.LL226:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	9
	...
	.dbg	line,	"include\routines_LEVELS.c", 1268; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_208 , TILES_16);
	__st.wmiq	18432, _di
	...
	.dbg	line,	"include\routines_LEVELS.c", 1271; else if(player_counter_anim == 12)
	__bra		.LL229
.LL228:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	12
	...
	.dbg	line,	"include\routines_LEVELS.c", 1273; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_192 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 6144, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1276; else if(player_counter_anim == 15)
	__bra		.LL231
.LL230:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	15
	...
	.dbg	line,	"include\routines_LEVELS.c", 1278; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_176 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 5632, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1282; player_counter_anim += 1;
.LL232:
.LL231:
.LL229:
.LL227:
...
.LL223:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1284; if(player_counter_anim == 17)
	__ld.umq	_player_counter_anim
	__equ_b.uiq	17
	__bfalse	.LL233
	...
	.dbg	line,	"include\routines_LEVELS.c", 1286; player_counter_anim = 0;
	__st.umiq	0, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1287; }

	.dbg	line,	"include\routines_LEVELS.c", 1289; recenter_CAMERA();
.LL233:
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 1290; }

	.dbg	line,	"include\routines_LEVELS.c", 1293; else if(player_state == STATE_CLIMB_DOWN)
	__bra		.LL234
.LL221:
	__ld.umq	_player_state
	__equ_b.uiq	12
	...
	.dbg	line,	"include\routines_LEVELS.c", 1295; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL236

	.dbg	line,	"include\routines_LEVELS.c", 1296; {

	.dbg	line,	"include\routines_LEVELS.c", 1297; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_176 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 5632, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
...
.LL236:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1302; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_192 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 6144, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1305; else if(player_counter_anim == 6)
	__bra		.LL239
.LL238:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	6
	...
	.dbg	line,	"include\routines_LEVELS.c", 1307; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_208 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 6656, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1310; else if(player_counter_anim == 9)
	__bra		.LL241
.LL240:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	9
	...
	.dbg	line,	"include\routines_LEVELS.c", 1312; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_192 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 6144, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1315; else if(player_counter_anim == 12)
	__bra		.LL243
.LL242:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	12
	...
	.dbg	line,	"include\routines_LEVELS.c", 1317; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_176 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 5632, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1320; else if(player_counter_anim == 15)
	__bra		.LL245
.LL244:
	__ld.umq	_player_counter_anim
	__equ_b.uiq	15
	...
	.dbg	line,	"include\routines_LEVELS.c", 1322; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_160 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 5120, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1326; player_counter_anim += 1;
.LL246:
.LL245:
.LL243:
.LL241:
...
.LL237:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1328; if(player_counter_anim == 17)
	__ld.umq	_player_counter_anim
	__equ_b.uiq	17
	__bfalse	.LL247
	...
	.dbg	line,	"include\routines_LEVELS.c", 1333; recenter_CAMERA();
.LL247:
	__call		_recenter_CAMERA

	.dbg	line,	"include\routines_LEVELS.c", 1334; }

	.dbg	line,	"include\routines_LEVELS.c", 1337; else if(player_state == STATE_JUMP_LADDER)
	__bra		.LL248
.LL235:
	__ld.umq	_player_state
	__equ_b.uiq	13
	...
	.dbg	line,	"include\routines_LEVELS.c", 1339; unsigned char i;

	.dbg	line,	"include\routines_LEVELS.c", 1340; i = 1;
	__st.umiq	1, __update_PLAYER_end - 8  /* i */

	.dbg	line,	"include\routines_LEVELS.c", 1343; if(player_counter_anim == 0)
	__not.um	_player_counter_anim
	__bfalse	.LL250

	.dbg	line,	"include\routines_LEVELS.c", 1344; {

	.dbg	line,	"include\routines_LEVELS.c", 1345; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER + TILES_112 , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER + 3584, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3

	.dbg	line,	"include\routines_LEVELS.c", 1347; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1348; }

	.dbg	line,	"include\routines_LEVELS.c", 1351; player_pos_y += TABLE_PLAYER_JUMP_V[player_index_jump];
.LL250:
	__ldx.umq	_player_index_jump
	__ld.bax	_TABLE_PLAYER_JUMP_V
	__add_st.wmq	_player_pos_y

	.dbg	line,	"include\routines_LEVELS.c", 1353; spr_set(player_id);
	__ld.umq	_player_id
	__call		_spr_set.1

	.dbg	line,	"include\routines_LEVELS.c", 1354; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 1358; if(player_index_jump < 34)
	__ld.umq	_player_index_jump
	__ult_b.uiq	34
	__bfalse	.LL251
	...
	.dbg	line,	"include\routines_LEVELS.c", 1360; player_index_jump += 1;
	__add_st.umiq	1, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1361; }

	.dbg	line,	"include\routines_LEVELS.c", 1364; // CHECK COLLISION WITH FLOOR //
...
.LL251:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1367; check_FLOOR_R();
	__call		_check_FLOOR_R
...
.LL252:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1372; check_FLOOR_L();
	__call		_check_FLOOR_L

	.dbg	line,	"include\routines_LEVELS.c", 1373; }
.LL253:

	.dbg	line,	"include\routines_LEVELS.c", 1376; if(map_blk_flag == TILE_BG)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	1
	__bfalse	.LL254
	...
	.dbg	line,	"include\routines_LEVELS.c", 1378; // CALCULATE HOW MANY PIXELS THE PLAYER MOVED INTO THE GROUND //

	.dbg	line,	"include\routines_LEVELS.c", 1379; for(i=1; i<11 ; i++ )
	__st.umiq	1, __update_PLAYER_end - 8  /* i */
.LL255:
...
.LL257:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1381; if(player_axis == AXIS_RIGHT)
	__not.um	_player_axis
	__bfalse	.LL259

	.dbg	line,	"include\routines_LEVELS.c", 1382; {

	.dbg	line,	"include\routines_LEVELS.c", 1383; check_BG( 11 , i);
	__ld.wi		11
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1386; else
	__bra		.LL260
.LL259:

	.dbg	line,	"include\routines_LEVELS.c", 1387; {

	.dbg	line,	"include\routines_LEVELS.c", 1388; check_BG( 10 , i);
	__ld.wi		10
	__pusharg.wr
	__ld.um		__update_PLAYER_end - 8  /* i */
	__pusharg.wr
...
.LL260:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1394; load_vram(PLAYER_VRAM_ADR, tiles_SPR_PLAYER , TILES_16);
	__st.wmiq	18432, _di
	__farptr	_tiles_SPR_PLAYER, _bp_bank, _bp
	__st.wmiq	256, _ax
	 _load_vram.3
	...
	.dbg	line,	"include\routines_LEVELS.c", 1397; spr_y(player_pos_y);
	__ld.wm		_player_pos_y
	__call		_spr_y.1

	.dbg	line,	"include\routines_LEVELS.c", 1398; break;
	__bra		.LL258
...
.LL258:
	...
	.dbg	line,	"include\routines_LEVELS.c", 1403; player_counter_anim = 1;
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1404; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1405; jump_ladder = FALSE;
	__st.umiq	0, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 1406; jump_max_index = 34;
	__st.umiq	34, _jump_max_index

	.dbg	line,	"include\routines_LEVELS.c", 1407; player_state = STATE_IDLE;
	__st.umiq	0, _player_state

	.dbg	line,	"include\routines_LEVELS.c", 1408; return;
	__bra		.LL100

	.dbg	line,	"include\routines_LEVELS.c", 1409; }

	.dbg	line,	"include\routines_LEVELS.c", 1412; if(player_index_jump > 18)
.LL254:
	__ld.umq	_player_index_jump
	__ugt_b.uiq	18
	__bfalse	.LL262
	...
	.dbg	line,	"include\routines_LEVELS.c", 1414; // CHECK COLLISION WITH LADDERS //

	.dbg	line,	"include\routines_LEVELS.c", 1415; check_LADDER( 16 , 8 );
	__ld.wi		16
	__pusharg.wr
	__ld.wi		8
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1417; // IF PLAYER HITS THE LADDER //
	...
	.dbg	line,	"include\routines_LEVELS.c", 1420; // CAMERA GOES 8 PX BACKWARD //

	.dbg	line,	"include\routines_LEVELS.c", 1421; sgx_map_pxl_x = ( (sgx_map_pxl_x >> 3) << 3 );
	__ld.wm		_sgx_map_pxl_x
	__lsr.wi	3
	__asl.wi	3
	__st.wmq	_sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 1423; // SO WE UPDATE THE MAP //

	.dbg	line,	"include\routines_LEVELS.c", 1424; sgx_scroll_map();
	__call		_sgx_scroll_map

	.dbg	line,	"include\routines_LEVELS.c", 1426; // CHECK IF THE PLAYER STANDS RIGHT TO THE LADDER //

	.dbg	line,	"include\routines_LEVELS.c", 1427; check_LADDER( 31 , 8 );
	__ld.wi		31
	__pusharg.wr
	__ld.wi		8
	__pusharg.wr
	...
	.dbg	line,	"include\routines_LEVELS.c", 1429; if(map_blk_flag == TILE_LADDER)
	__ld.umq	_map_blk_flag
	__equ_b.uiq	2
	__bfalse	.LL264
	...
	.dbg	line,	"include\routines_LEVELS.c", 1431; sgx_map_pxl_x += 8;
	__add_st.wmiq	8, _sgx_map_pxl_x

	.dbg	line,	"include\routines_LEVELS.c", 1432; }

	.dbg	line,	"include\routines_LEVELS.c", 1434; player_counter_anim = 1;
.LL264:
	__st.umiq	1, _player_counter_anim

	.dbg	line,	"include\routines_LEVELS.c", 1435; player_index_jump = 0;
	__st.umiq	0, _player_index_jump

	.dbg	line,	"include\routines_LEVELS.c", 1436; jump_ladder = TRUE;
	__st.umiq	1, _jump_ladder

	.dbg	line,	"include\routines_LEVELS.c", 1437; jump_max_index = 29;
	__st.umiq	29, _jump_max_index

	.dbg	line,	"include\routines_LEVELS.c", 1438; player_state = STATE_HANG;
	__st.umiq	10, _player_state
...
.LL282:
	...
	.dbg	line,	"main.c", 85; put_number(player_index_jump,2,0,1);

	.dbg	line,	"main.c", 86; put_number(TABLE_PLAYER_FALL[player_index_jump],2,0,2);

	.dbg	line,	"main.c", 87; put_number(player_pos_y,3,0,3);*/
